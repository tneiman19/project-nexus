...
(function (V, _t) {
  typeof exports == "object" && typeof module < "u"
    ...
    ? define(["exports"], _t)
    : ((V = typeof globalThis < "u" ? globalThis : V || self), _t((V.te = {})));
})(this, function (V) {
  "use strict";
  var Dk = Object.defineProperty;
  var Mk = (V, _t, P) =>
    _t in V
      ? Dk(V, _t, { enumerable: !0, configurable: !0, writable: !0, value: P })
      : (V[_t] = P);
  ...
  const _t = (() => {
    ...
    Gp = (i) => {
      ...
      return !s && !n
        ...
        : ((t = t.split(",")[0]),
          (e = e.split(",")[0]),
          (Number.parseFloat(t) + Number.parseFloat(e)) * Up);
    },
    Ll = (i) => {
    ...
    Er = {};
  let Hl = 1;
  const t_ = { mouseenter: "mouseover", mouseleave: "mouseout" },
    e_ = /^(mouseenter|mouseleave)/i,
    Fl = new Set([
      "click",
      "dblclick",
      "mouseup",
  ...
  function i_(i, t) {
    return function e(s) {
      return (
        (s.delegateTarget = i), e.oneOff && b.off(i, s.type, t), t.apply(i, [s])
      );
    };
  }
  function s_(i, t, e) {
  ...
  class On extends Xt {
    ...
    toggle() {
      this._element.setAttribute(
        "aria-pressed",
        this._element.classList.toggle(a_)
      );
    }
  ...
  var gt = "top",
    ...
    Ri = "popper",
    Xl = "reference",
    Ar = Li.reduce(function (i, t) {
      return i.concat([t + "-" + ni, t + "-" + Pi]);
    }, []),
    wr = [].concat(Li, [bs]).reduce(function (i, t) {
      return i.concat([t, t + "-" + ni, t + "-" + Pi]);
    }, []),
    Gl = "beforeRead",
    ql = "read",
    Zl = "afterRead",
  ...
  function $i(i, t, e) {
    ...
    t &&
      It(i) &&
      ((n = (i.offsetWidth > 0 && Ni(s.width) / i.offsetWidth) || 1),
      (o = (i.offsetHeight > 0 && Ni(s.height) / i.offsetHeight) || 1));
    var r = oi(i) ? Mt(i) : window,
      a = r.visualViewport,
      l = !nc() && e,
  ...
  function Pe(i) {
    return (
      (oi(i) ? i.ownerDocument : i.document) || window.document
    ).documentElement;
  }
  function In(i) {
    return oe(i) === "html"
      ? i
      : i.assignedSlot || i.parentNode || (kr(i) ? i.host : null) || Pe(i);
  }
  function rc(i) {
    return !It(i) || qt(i).position === "fixed" ? null : i.offsetParent;
  }
  function d_(i) {
    var t = /firefox/i.test(Or()),
      e = /Trident/i.test(Or());
    if (e && It(i)) {
      var s = qt(i);
  ...
  function vs(i) {
    for (var t = Mt(i), e = rc(i); e && h_(e) && qt(e).position === "static"; )
      e = rc(e);
    return e &&
      (oe(e) === "html" || (oe(e) === "body" && qt(e).position === "static"))
      ? t
      : e || d_(i) || t;
  }
  function Mr(i) {
  ...
  var g_ = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
  function m_(i, t) {
    var e = i.x,
      s = i.y,
      n = t.devicePixelRatio || 1;
    return { x: Ni(e * n) / n || 0, y: Ni(s * n) / n || 0 };
  }
  function dc(i) {
    var t,
      e = i.popper,
      ...
      p = r.y,
      _ = p === void 0 ? 0 : p,
      m = typeof h == "function" ? h({ x: f, y: _ }) : { x: f, y: _ };
    (f = m.x), (_ = m.y);
    ...
    if (c) {
      ...
      if (
        ...
        C = Ot;
        var k =
          d && A === T && T.visualViewport ? T.visualViewport.height : A[w];
        (_ -= k - s.height), (_ *= l ? 1 : -1);
      }
      if (n === mt || ((n === gt || n === Ot) && o === Pi)) {
        E = Dt;
        var D =
          d && A === T && T.visualViewport ? T.visualViewport.width : A[S];
        (f -= D - s.width), (f *= l ? 1 : -1);
      }
    }
    var O = Object.assign({ position: a }, c && g_),
      M = h === !0 ? m_({ x: f, y: _ }, Mt(e)) : { x: f, y: _ };
    if (((f = M.x), (_ = M.y), l)) {
      var L;
...
`,
  ...
  var y_ = { left: "right", right: "left", bottom: "top", top: "bottom" };
  function Pn(i) {
  ...
  function E_(i, t) {
    ...
    return { width: o, height: r, x: a + Rr(i), y: l };
  }
  function C_(i) {
    var t,
      e = Pe(i),
    ...
    return (
      qt(n || e).direction === "rtl" &&
        (a += ri(e.clientWidth, n ? n.clientWidth : 0) - o),
  ...
  function xs(i, t) {
    ...
    var s = fc(i),
      ...
      o = Mt(s),
      r = n ? [o].concat(o.visualViewport || [], Nr(s) ? s : []) : s,
      a = t.concat(r);
  ...
  function w_(i, t, e, s) {
    var n = t === "clippingParents" ? A_(i) : [].concat(t),
      o = [].concat(n, [e]),
      r = o[0],
      a = o.reduce(function (l, c) {
        var h = pc(i, c, s);
        return (
          (l.top = ri(h.top, l.top)),
          (l.right = Mn(h.right, l.right)),
          (l.bottom = Mn(h.bottom, l.bottom)),
          (l.left = ri(h.left, l.left)),
          l
        );
      }, pc(i, r, s));
    return (
  ...
  function Hi(i, t) {
    ...
    var e = t,
      ...
      _ = e.padding,
      m = _ === void 0 ? 0 : _,
      y = lc(typeof m != "number" ? m : cc(m, Li)),
      x = u === Ri ? Xl : Ri,
      E = i.rects.popper,
      C = i.elements[p ? x : u],
      T = w_(oi(C) ? C : C.contextElement || Pe(i.elements.popper), l, h, r),
      A = $i(i.elements.reference),
      w = _c({ reference: A, element: E, strategy: "absolute", placement: n }),
      S = $r(Object.assign({}, E, w)),
      k = u === Ri ? S : A,
      D = {
    ...
    if (u === Ri && O) {
      ...
      Object.keys(D).forEach(function (L) {
        var X = [Dt, Ot].indexOf(L) >= 0 ? 1 : -1,
          I = [gt, Ot].indexOf(L) >= 0 ? "y" : "x";
        D[L] += M[I] * X;
      });
    }
    return D;
  ...
  function k_(i, t) {
    ...
    var e = t,
      ...
      d = h
        ? a
          ? Ar
          : Ar.filter(function (p) {
              return Bi(p) === h;
            })
        : Li,
      u = d.filter(function (p) {
    ...
    if (!t.modifiersData[s]._skip) {
      for (
        var n = e.mainAxis,
          ...
          x = y === m,
          E = l || (x || !p ? [Pn(m)] : S_(m)),
          C = [m].concat(E).reduce(function (xe, Ut) {
            return xe.concat(
              Gt(Ut) === bs
                ? k_(t, {
                    placement: Ut,
        ...
        if (
          (o && ee.push(F[M] <= 0),
          a && ee.push(F[Y] <= 0, F[Yt] <= 0),
          ee.every(function (xe) {
            return xe;
          }))
        ) {
          (k = O), (S = !1);
          ...
          var ie = p ? 3 : 1,
            ti = function (Ut) {
              var Me = C.find(function (mr) {
                var Oi = w.get(mr);
                if (Oi)
                  return Oi.slice(0, Ut).every(function (Ol) {
                    return Ol;
                  });
              });
  ...
  function D_(i) {
    var t = i.state,
      ...
      r = Hi(t, { elementContext: "reference" }),
      a = Hi(t, { altBoundary: !0 }),
      l = mc(r, s),
      c = mc(a, n, o),
      h = bc(l),
      d = bc(c);
  ...
  function R_(i) {
    var t = i.state,
      ...
      p = e.tetherOffset,
      _ = p === void 0 ? 0 : p,
      m = Hi(t, { boundary: l, rootBoundary: c, padding: d, altBoundary: h }),
      y = Gt(t.placement),
      x = Bi(t.placement),
      E = !x,
      C = Mr(y),
    ...
    if (A) {
      if (o) {
        var L,
          ...
          Kt = x === ni ? -S[F] : -w[F],
          ye = t.elements.arrow,
          xe = f && ye ? Dr(ye) : { width: 0, height: 0 },
          ...
          Oi = ys(0, w[F], xe[F]),
          Ol = E
            ? w[F] / 2 - ie - Oi - Me - D.mainAxis
            : ti - Oi - Me - D.mainAxis,
          Tk = E
            ? -w[F] / 2 + ie + Oi + mr + D.mainAxis
            : Kt + Oi + mr + D.mainAxis,
          Dl = t.elements.arrow && vs(t.elements.arrow),
          Ak = Dl ? (C === "y" ? Dl.clientTop || 0 : Dl.clientLeft || 0) : 0,
          Rp = (L = O == null ? void 0 : O[C]) != null ? L : 0,
          wk = Y + Ol - Rp - Ak,
          kk = Y + Tk - Rp,
          Np = ys(f ? Mn(Yt, wk) : Yt, Y, f ? ri(ee, kk) : ee);
        (A[C] = Np), (M[C] = Np - Y);
      }
      if (a) {
        var $p,
          ...
          Bp = Di + m[Sk],
          Hp = Di - m[Ok],
          Ml = [gt, mt].indexOf(y) !== -1,
          Fp = ($p = O == null ? void 0 : O[T]) != null ? $p : 0,
          Vp = Ml ? Bp : Di - w[br] - S[br] - Fp + D.altAxis,
          Wp = Ml ? Di + w[br] + S[br] - Fp - D.altAxis : Hp,
          zp = f && Ml ? u_(Vp, Di, Wp) : ys(f ? Vp : Bp, Di, f ? Wp : Hp);
        (A[T] = zp), (M[T] = zp - Di);
      }
      t.modifiersData[s] = M;
    }
  ...
  function B_(i) {
    var t = i.getBoundingClientRect(),
      e = Ni(t.width) / i.offsetWidth || 1,
      s = Ni(t.height) / i.offsetHeight || 1;
    return e !== 1 || s !== 1;
  }
  function H_(i, t, e) {
    e === void 0 && (e = !1);
    ...
    return (
      (s || (!s && !e)) &&
        ((oe(t) !== "body" || Nr(o)) && (a = $_(t)),
        It(t)
          ? ((l = $i(t, !0)), (l.x += t.clientLeft), (l.y += t.clientTop))
          : o && (l.x = Rr(o))),
      {
          ...
          switch (e) {
            ...
            case "fn":
              typeof t.fn != "function" &&
                console.error(
                  Re(ai, t.name, '"fn"', '"function"', '"' + String(t.fn) + '"')
                );
              break;
            case "effect":
              t.effect != null &&
  ...
  var Cc =
    ...
    Tc = { placement: "bottom", modifiers: [], strategy: "absolute" };
  function Ac() {
  ...
  function Rn(i) {
    ...
    return function (a, l, c) {
            ...
            if (!u) {
              ...
              for (var C = 0, T = 0; T < h.orderedModifiers.length; T++) {
                ...
                var A = h.orderedModifiers[T],
                  ...
                  D = A.name;
                typeof w == "function" &&
                  (h = w({ state: h, options: k, name: D, instance: f }) || h);
              }
            }
          },
          update: W_(function () {
      ...
      if (!Ac(a, l))
        return {}.NODE_ENV !== "production" && console.error(Cc), f;
      ...
      function p() {
        h.orderedModifiers.forEach(function (m) {
          ...
          if (typeof C == "function") {
            var T = C({ state: h, name: y, instance: f, options: E }),
              A = function () {};
            d.push(T || A);
          }
        });
  ...
  var X_ = Rn(),
    G_ = [Lr, Br, Ir, Sr],
    q_ = Rn({ defaultModifiers: G_ }),
    Z_ = [Lr, Br, Ir, Sr, yc, gc, xc, hc, vc],
    Fi = Rn({ defaultModifiers: Z_ });
  ...
  const Q_ = 3,
    g = {
      ...
      parents(i, t) {
        const e = [];
        let s = i.parentNode;
        for (; s && s.nodeType === Node.ELEMENT_NODE && s.nodeType !== Q_; )
    ...
    lg = "dropend",
    cg = "dropstart",
    hg = "[data-te-navbar-ref]",
    Bn = "[data-te-dropdown-toggle-ref]",
    Yr = "[data-te-dropdown-menu-ref]",
    dg = "[data-te-navbar-nav-ref]",
    ug =
      "[data-te-dropdown-menu-ref] [data-te-dropdown-item-ref]:not(.disabled):not(:disabled)",
    fg = st() ? "top-end" : "top-start",
    pg = st() ? "top-start" : "top-end",
    _g = st() ? "bottom-end" : "bottom-start",
    gg = st() ? "bottom-start" : "bottom-end",
    mg = st() ? "left-start" : "right-start",
    bg = st() ? "right-start" : "left-start",
    vg = [{ opacity: "0" }, { opacity: "1" }],
    yg = [{ opacity: "1" }, { opacity: "0" }],
    Hn = { duration: 550, iterations: 1, easing: "ease", fill: "both" },
    xg = {
      offset: [0, 2],
  ...
  class $t extends Xt {
      ...
      this._inNavbar
        ...
        "ontouchstart" in document.documentElement &&
          ...
          []
            ...
            .forEach((n) => b.on(n, "mouseover", Sn)),
        this._element.focus(),
        this._element.setAttribute("aria-expanded", !0),
        this._menu.setAttribute(`data-te-dropdown-${Ne}`, ""),
        this._animationCanPlay && this._menu.animate(vg, Hn),
        this._element.setAttribute(`data-te-dropdown-${Ne}`, ""),
        setTimeout(
          () => {
    ...
    _init() {
      this._didInit ||
        (b.on(document, Oc, Bn, $t.dataApiKeydownHandler),
        b.on(document, Oc, Yr, $t.dataApiKeydownHandler),
        b.on(document, og, $t.clearMenus),
        b.on(document, rg, $t.clearMenus),
        (this._didInit = !0));
    }
    _completeHide(t) {
      (this._fadeOutAnimate && this._fadeOutAnimate.playState === "running") ||
        b.trigger(this._element, eg, t).defaultPrevented ||
        ("ontouchstart" in document.documentElement &&
          []
            .concat(...document.body.children)
            .forEach((s) => b.off(s, "mouseover", Sn)),
        this._animationCanPlay &&
          (this._fadeOutAnimate = this._menu.animate(yg, Hn)),
        setTimeout(
          () => {
            this._popper && this._popper.destroy(),
              this._menu.removeAttribute(`data-te-dropdown-${Ne}`),
              this._element.removeAttribute(`data-te-dropdown-${Ne}`),
              this._element.setAttribute("aria-expanded", "false"),
              v.removeDataAttribute(this._menu, "popper"),
              b.trigger(this._element, ig, t);
          },
          this._animationCanPlay ? Hn.duration : 0
        ));
    }
    _getConfig(t) {
      if (
        ...
        W(Wr, t, this.constructor.DefaultType),
        typeof t.reference == "object" &&
          !Mi(t.reference) &&
          typeof t.reference.getBoundingClientRect != "function")
      )
        throw new TypeError(
          `${Wr.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`
        );
      return t;
    }
    _createPopper(t) {
      ...
      this._config.reference === "parent"
        ? (e = t)
        : Mi(this._config.reference)
        ? (e = Le(this._config.reference))
      ...
      (this._popper = Fi(e, this._menu, s)),
        n && v.setDataAttribute(this._menu, "popper", "static");
    }
    _isShown(t = this._element) {
      return (
        t.dataset[`teDropdown${Ne.charAt(0).toUpperCase() + Ne.slice(1)}`] ===
        ""
      );
    }
    _getMenuElement() {
    ...
    static clearMenus(t) {
      if (t && (t.button === J_ || (t.type === "keyup" && t.key !== Sc)))
        return;
      const e = g.find(Bn);
    ...
    static dataApiKeydownHandler(t) {
      if (
        /input|textarea/i.test(t.target.tagName)
          ? t.key === kc ||
            (t.key !== Nn &&
              ((t.key !== $n && t.key !== jr) || t.target.closest(Yr)))
          : !tg.test(t.key)
      )
        return;
      const e =
        this.dataset[
          `teDropdown${Ne.charAt(0).toUpperCase() + Ne.slice(1)}`
        ] === "";
      if (
        (!e && t.key === Nn) ||
        (t.preventDefault(), t.stopPropagation(), ei(this))
      )
        return;
      const s = this.matches(Bn) ? this : g.prev(this, Bn)[0],
        n = $t.getOrCreateInstance(s);
      if (t.key === Nn) {
        n.hide();
        return;
      }
  ...
  const Kr = "collapse",
    Dc = "te.collapse",
    Fn = `.${Dc}`,
    Mc = { toggle: !0, parent: null },
    Cg = { toggle: "boolean", parent: "(null|element)" },
    Tg = `show${Fn}`,
    Ag = `shown${Fn}`,
    wg = `hide${Fn}`,
    kg = `hidden${Fn}`,
    Ur = "data-te-collapse-show",
    Ic = "data-te-collapse-collapsed",
    Vn = "data-te-collapse-collapsing",
    Sg = "data-te-collapse-horizontal",
    Vi = "data-te-collapse-item",
    Lc = `:scope [${Vi}] [${Vi}]`,
    Og = "width",
    Dg = "height",
    Mg =
      "[data-te-collapse-item][data-te-collapse-show], [data-te-collapse-item][data-te-collapse-collapsing]",
    Pc = "[data-te-collapse-init]",
    Ig = {
      visible: "!visible",
      hidden: "hidden",
      baseTransition:
  ...
  class re extends Xt {
    constructor(t, e, s) {
      ...
      for (let o = 0, r = n.length; o < r; o++) {
        const a = n[o],
          l = yr(a),
          c = g.find(l).filter((h) => h === this._element);
        l !== null &&
          c.length &&
    ...
    show() {
      ...
      if (t.length) {
        ...
        if (((e = h ? re.getInstance(h) : null), e && e._isTransitioning))
          return;
      }
      if (b.trigger(this._element, Tg).defaultPrevented) return;
      t.forEach((h) => {
        s !== h && re.getOrCreateInstance(h, { toggle: !1 }).hide(),
          e || P.setData(h, Dc, null);
      });
      ...
      v.removeClass(this._element, this._classes.visible),
        v.removeClass(this._element, this._classes.hidden),
        v.addClass(this._element, r),
        this._element.removeAttribute(Vi),
        this._element.setAttribute(Vn, ""),
      ...
      const a = () => {
          (this._isTransitioning = !1),
            v.removeClass(this._element, this._classes.hidden),
            v.removeClass(this._element, r),
            v.addClass(this._element, this._classes.visible),
            this._element.removeAttribute(Vn),
            this._element.setAttribute(Vi, ""),
            this._element.setAttribute(Ur, ""),
            (this._element.style[o] = ""),
            b.trigger(this._element, Ag);
        },
    ...
    hide() {
      if (
        ...
        !this._isShown() ||
        b.trigger(this._element, wg).defaultPrevented
      )
        return;
      ...
      const o = () => {
        (this._isTransitioning = !1),
          ...
          v.addClass(this._element, this._classes.visible),
          v.addClass(this._element, this._classes.hidden),
          this._element.removeAttribute(Vn),
          this._element.setAttribute(Vi, ""),
          b.trigger(this._element, kg);
      };
    ...
    _getConfig(t) {
      return (
        (t = { ...Mc, ...v.getDataAttributes(this._element), ...t }),
        (t.toggle = !!t.toggle),
        (t.parent = Le(t.parent)),
        W(Kr, t, Cg),
        t
      );
    }
    ...
    _addAriaAndCollapsedClass(t, e) {
      t.length &&
        t.forEach((s) => {
          e ? s.removeAttribute(Ic) : s.setAttribute(`${Ic}`, ""),
  ...
  class Es {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        ...
        this._setElementAttributes(Rc, "paddingRight", (e) => e + t),
        this._setElementAttributes(Nc, "marginRight", (e) => e - t);
    }
    _disableOverFlow() {
    ...
    reset() {
      this._resetElementAttributes(this._element, "overflow"),
        ...
        this._resetElementAttributes(Rc, "paddingRight"),
        this._resetElementAttributes(Nc, "marginRight");
    }
    ...
    _resetElementAttributes(t, e) {
      const s = (n) => {
        ...
        typeof o > "u"
          ...
          : (v.removeDataAttribute(n, e), (n.style[e] = o));
      };
  ...
  class Xr {
    ...
    show(t) {
      ...
      v.removeClass(this._getElement(), "opacity-0"),
        v.addClass(this._getElement(), e),
    ...
    _getConfig(t) {
      return (
        (t = { ...Pg, ...(typeof t == "object" ? t : {}) }),
        (t.rootElement = Le(t.rootElement)),
        W($c, t, Rg),
        t
      );
    }
  ...
  class Cs {
    ...
    _setElements() {
      (this._focusableElements = g.focusableChildren(this._element)),
        this._onlyVisible &&
  ...
  const Wn = (i, t = "hide") => {
      ...
      b.on(document, e, `[data-te-${s}-dismiss]`, function (n) {
        if (
          (["A", "AREA"].includes(this.tagName) && n.preventDefault(), ei(this))
        )
          return;
        const o =
          Ie(this) ||
    ...
    Ng = `load${Wi}.data-api`,
    $g = "Escape",
    Fc = { backdrop: !0, keyboard: !0, scroll: !1 },
    Bg = { backdrop: "boolean", keyboard: "boolean", scroll: "boolean" },
    Vc = "show",
    Hg = "[data-te-offcanvas-init][data-te-offcanvas-show]",
    Fg = `show${Wi}`,
    Vg = `shown${Wi}`,
    Wg = `hide${Wi}`,
    zg = `hidden${Wi}`,
    jg = `keydown.dismiss${Wi}`;
  class zi extends Xt {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
    ...
    show(t) {
      if (
        this._isShown ||
        b.trigger(this._element, Fg, { relatedTarget: t }).defaultPrevented
      )
        return;
      (this._isShown = !0),
        ...
        this._element.setAttribute(`data-te-offcanvas-${Vc}`, "");
      const s = () => {
        this._config.scroll || this._focustrap.trap(),
          b.trigger(this._element, Vg, { relatedTarget: t });
      };
      this._queueCallback(s, this._element, !0);
    }
    hide() {
      if (!this._isShown || b.trigger(this._element, Wg).defaultPrevented)
        return;
      this._focustrap.disable(),
        this._element.blur(),
        (this._isShown = !1),
        this._element.removeAttribute(`data-te-offcanvas-${Vc}`),
        this._backdrop.hide();
      const e = () => {
    ...
    _init() {
      this._didInit ||
        (b.on(window, Ng, () =>
          g.find(Hg).forEach((t) => zi.getOrCreateInstance(t).show())
        ),
        Wn(zi),
        (this._didInit = !0));
    }
  ...
  const Gr = "alert",
    ...
    Yg = `close${Wc}`,
    Kg = `closed${Wc}`,
    Ts = "data-te-alert-show",
    Ug = { animation: "boolean", autohide: "boolean", delay: "number" },
    zc = { animation: !0, autohide: !0, delay: 1e3 },
    Xg = {
      fadeIn:
    ...
    Gg = { fadeIn: "string", fadeOut: "string" };
  class As extends Xt {
    constructor(t, e, s) {
      super(t),
        (this._element = t),
    ...
    close() {
      ...
      this._config.animation &&
        ((e = 300), v.addClass(this._element, this._classes.fadeOut)),
    ...
    show() {
      if (this._element) {
        if (
          ...
          !this._element.hasAttribute(Ts) &&
            (v.removeClass(this._element, "hidden"),
            v.addClass(this._element, "block"),
            ne(this._element)))
        ) {
          const t = (e) => {
            v.removeClass(this._element, "hidden"),
              v.addClass(this._element, "block"),
              b.off(e.target, "animationend", t);
          };
          this._element.setAttribute(Ts, ""),
            b.on(this._element, "animationend", t);
        }
        this._config.animation &&
          (v.removeClass(this._element, this._classes.fadeOut),
          v.addClass(this._element, this._classes.fadeIn));
      }
    }
    hide() {
      if (this._element && this._element.hasAttribute(Ts)) {
        this._element.removeAttribute(Ts);
        const t = (e) => {
          v.addClass(this._element, "hidden"),
            v.removeClass(this._element, "block"),
            this._timeout !== null &&
              (clearTimeout(this._timeout), (this._timeout = null)),
            b.off(e.target, "animationend", t);
        };
        b.on(this._element, "animationend", t),
          v.removeClass(this._element, this._classes.fadeIn),
          v.addClass(this._element, this._classes.fadeOut);
      }
    }
    _init() {
    ...
    _getConfig(t) {
      return (
        ...
        W(Gr, t, this.constructor.DefaultType),
        t
      );
    }
    _getClasses(t) {
      const e = v.getDataClassAttributes(this._element);
      return (t = { ...Xg, ...e, ...t }), W(Gr, t, Gg), t;
    }
    _setupAutohide() {
  ...
  const qr = "carousel",
    ...
    pm = `load${Lt}${jc}`,
    _m = `click${Lt}${jc}`,
    gm = "data-te-carousel-init",
    ui = "data-te-carousel-active",
    mm = "data-te-carousel-slide",
    bm = "data-te-carousel-item-end",
    Zr = "data-te-carousel-item-start",
    vm = "data-te-carousel-item-next",
    ym = "data-te-carousel-item-prev",
    xm = "data-te-carousel-pointer-event",
    Em = "[data-te-carousel-init]",
    Uc = "[data-te-carousel-active]",
    Qr = "[data-te-carousel-item]",
    ji = `${Uc}${Qr}`,
    Cm = `${Qr} img`,
    Tm = "[data-te-carousel-item-next], [data-te-carousel-item-prev]",
    Am = "[data-te-carousel-indicators]",
    wm = "[data-te-target]",
    km = "[data-te-slide], [data-te-slide-to]",
    Sm = "touch",
    Om = "pen";
  class ae extends Xt {
    constructor(t, e, s) {
      super(t),
        ...
        (this._config = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        (this._indicatorsElement = g.findOne(Am, this._element)),
    ...
    pause(t) {
      t || (this._isPaused = !0),
        g.findOne(Tm, this._element) && (Ll(this._element), this.cycle(!0)),
    ...
    _init() {
      this._didInit ||
        (b.on(document, _m, km, ae.dataApiClickHandler),
        b.on(window, pm, () => {
          const t = g.find(Em);
          for (let e = 0, s = t.length; e < s; e++)
            ae.carouselInterface(t[e], ae.getInstance(t[e]));
        }),
        (this._didInit = !0));
    }
    _getConfig(t) {
    ...
    _setActiveElementClass() {
      (this._activeElement = g.findOne(ji, this._element)),
        v.addClass(this._activeElement, "hidden");
    }
    _addEventListeners() {
      this._config.keyboard && b.on(this._element, om, (t) => this._keydown(t)),
        this._config.pause === "hover" &&
          (b.on(this._element, rm, (t) => this.pause(t)),
          b.on(this._element, am, (t) => this.cycle(t))),
        this._config.touch &&
          this._touchSupported &&
    ...
    _addTouchEventListeners() {
      const t = (o) =>
          this._pointerEvent && (o.pointerType === Om || o.pointerType === Sm),
        e = (o) => {
          t(o)
      ...
      g.find(Cm, this._element).forEach((o) => {
        ...
        this._pointerEvent
          ? (b.on(this._element, dm, (o) => e(o)),
            b.on(this._element, um, (o) => n(o)),
            this._element.classList.add(this._classes.pointer),
            this._element.setAttribute(`${xm}`, ""))
          : (b.on(this._element, lm, (o) => e(o)),
            b.on(this._element, cm, (o) => s(o)),
            b.on(this._element, hm, (o) => n(o)));
    }
    _keydown(t) {
    ...
    _getItemIndex(t) {
      return (
        (this._items = t && t.parentNode ? g.find(Qr, t.parentNode) : []),
    ...
    _triggerSlideEvent(t, e) {
      const s = this._getItemIndex(t),
        n = this._getItemIndex(g.findOne(ji, this._element));
    ...
    _slide(t, e) {
      const s = this._directionToOrder(t),
        ...
        f = h === Zr ? this._classes.slideLeft : this._classes.slideRight,
        p = h !== Zr ? this._classes.slideLeft : this._classes.slideRight;
      ...
      if (this._element.hasAttribute(mm)) {
        r.setAttribute(`${d}`, ""),
          r.classList.add(this._classes.block, p),
          Ii(r),
          n.setAttribute(`${h}`, ""),
    ...
    static dataApiClickHandler(t) {
      ...
      n && (s.interval = !1),
        ae.carouselInterface(e, s),
        n && ae.getInstance(e).to(n),
        t.preventDefault();
    }
  }
  const Jr = "modal",
    Zt = ".te.modal",
    Xc = "Escape",
    Gc = { backdrop: !0, keyboard: !0, focus: !0 },
    Dm = {
    ...
    Im = { show: "string", static: "string", staticProperties: "string" },
    Lm = `hide${Zt}`,
    Pm = `hidePrevented${Zt}`,
    Rm = `hidden${Zt}`,
    Nm = `show${Zt}`,
    ...
    qc = `resize${Zt}`,
    Zc = `click.dismiss${Zt}`,
    Qc = `keydown.dismiss${Zt}`,
    Bm = `mouseup.dismiss${Zt}`,
    Jc = `mousedown.dismiss${Zt}`,
    th = "data-te-modal-open",
    eh = "data-te-open",
    ks = "[data-te-modal-dialog-ref]",
    Hm = "[data-te-modal-body-ref]";
  class Ss extends Xt {
    constructor(t, e, s) {
      super(t),
        (this._config = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        (this._dialog = g.findOne(ks, this._element)),
        (this._backdrop = this._initializeBackDrop()),
        (this._focustrap = this._initializeFocusTrap()),
        (this._isShown = !1),
    ...
    show(t) {
      this._isShown ||
        this._isTransitioning ||
        b.trigger(this._element, Nm, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        this._isAnimated() && (this._isTransitioning = !0),
        this._scrollBar.hide(),
        document.body.setAttribute(th, "true"),
        this._adjustDialog(),
        this._setEscapeEvent(),
        this._setResizeEvent(),
        b.on(this._dialog, Jc, () => {
    ...
    hide() {
      if (
        !this._isShown ||
        this._isTransitioning ||
        b.trigger(this._element, Lm).defaultPrevented
      )
        return;
      this._isShown = !1;
      ...
      e && (this._isTransitioning = !0),
        ...
        this._setResizeEvent(),
        this._focustrap.disable(),
        g.findOne(ks, this._element).classList.remove(this._classes.show),
        b.off(this._element, Zc),
        b.off(this._dialog, Jc),
        this._queueCallback(() => this._hideModal(), this._element, e),
        this._element.removeAttribute(eh);
    }
    dispose() {
      [window, this._dialog].forEach((t) => b.off(t, Zt)),
    ...
    _getClasses(t) {
      const e = v.getDataClassAttributes(this._element);
      return (t = { ...Mm, ...e, ...t }), W(Jr, t, Im), t;
    }
    _showElement(t) {
      const e = this._isAnimated(),
        s = g.findOne(Hm, this._dialog);
      ...
      const o = () => {
        this._config.focus && this._focustrap.trap(),
          (this._isTransitioning = !1),
          b.trigger(this._element, $m, { relatedTarget: t });
      };
    ...
    _setEscapeEvent() {
      this._isShown
        ? b.on(document, Qc, (t) => {
            this._config.keyboard && t.key === Xc
    ...
    _setResizeEvent() {
      this._isShown
        ? b.on(window, qc, () => this._adjustDialog())
        : b.off(window, qc);
    }
    _hideModal() {
      ...
      t.classList.remove(this._classes.show),
        ...
        (this._isTransitioning = !1),
        this._backdrop.hide(() => {
          document.body.removeAttribute(th),
            this._resetAdjustments(),
            this._scrollBar.reset(),
            b.trigger(this._element, Rm);
        });
    }
    _showBackdrop(t) {
  ...
  const Fm = new Set([
    ...
    Vm = /^aria-[\w-]*$/i,
    Wm = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
    zm =
    ...
    jm = (i, t) => {
      ...
      if (t.includes(e))
        return Fm.has(e)
          ? !!(Wm.test(i.nodeValue) || zm.test(i.nodeValue))
          : !0;
  ...
  const sh = "tooltip",
    le = ".te.tooltip",
    Km = "te-tooltip",
    Um = new Set(["sanitize", "allowList", "sanitizeFn"]),
    Xm = {
      animation: "boolean",
      template: "string",
  ...
  let Ms = class jp extends Xt {
    ...
    dispose() {
      clearTimeout(this._timeout),
        b.off(this._element.closest(oh), rh, this._hideModalHandler),
    ...
    show() {
      ...
      this.constructor.NAME === "tooltip" &&
        this.tip &&
        this.getTitle() !== this.tip.querySelector(nh).innerHTML &&
        (this._disposePopper(), this.tip.remove(), (this.tip = null));
      const n = this.getTipElement(),
        o = se(this.constructor.NAME);
      n.setAttribute("id", o),
      ...
      if (
        (P.setData(n, this.constructor.DATA_KEY, this),
        this._element.ownerDocument.documentElement.contains(this.tip) ||
          (l.append(n),
          b.trigger(this._element, this.constructor.Event.INSERTED)),
        this._popper
          ? this._popper.update()
          : (this._popper = Fi(this._element, n, this._getPopperConfig(a))),
      ...
      h && n.classList.add(...h.split(" ")),
        "ontouchstart" in document.documentElement &&
          [].concat(...document.body.children).forEach((f) => {
            b.on(f, "mouseover", Sn);
          });
      const d = () => {
    ...
    hide() {
      ...
      t.classList.add("opacity-0"),
        ...
        "ontouchstart" in document.documentElement &&
          []
            .concat(...document.body.children)
            .forEach((o) => b.off(o, "mouseover", Sn)),
        (this._activeTrigger[tb] = !1),
    ...
    getTipElement() {
      ...
      return (
        this.setContent(e), e.classList.remove(Qm, ta), (this.tip = e), this.tip
      );
    }
    setContent(t) {
      ...
      if (t !== null) {
        ...
        this._config.html
          ? (this._config.sanitize &&
              (e = ih(e, this._config.allowList, this._config.sanitizeFn)),
            (t.innerHTML = e))
          : (t.textContent = e);
      }
    }
    ...
    _setListeners() {
      this._config.trigger.split(" ").forEach((e) => {
        if (e === "click")
          ...
          b.on(this._element, s, this._config.selector, (o) => this._enter(o)),
            b.on(this._element, n, this._config.selector, (o) =>
              this._leave(o)
            );
        }
      }),
        ...
        b.on(this._element.closest(oh), rh, this._hideModalHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
    ...
    _enter(t, e) {
      if (
        ...
        t && (e._activeTrigger[t.type === "focusin" ? ia : Ds] = !0),
        e.getTipElement().classList.contains(ta) || e._hoverState === Os)
      ) {
        e._hoverState = Os;
        return;
      }
    ...
    _leave(t, e) {
      if (
        ((e = this._initializeOnDelegatedTarget(t, e)),
        t &&
          (e._activeTrigger[t.type === "focusout" ? ia : Ds] =
    ...
    _getConfig(t) {
      ...
      return (
        ...
        W(sh, t, this.constructor.DefaultType),
        t.sanitize && (t.template = ih(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
  ...
  const ib = "popover",
    ...
    ob = { ...Ms.DefaultType, content: "(string|element|function)" },
    rb = {
      HIDE: `hide${ce}`,
      HIDDEN: `hidden${ce}`,
      SHOW: `show${ce}`,
  ...
  class zn extends Ms {
    ...
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), ab),
        this._sanitizeAndSetContent(t, this._getContent(), lb);
    }
    _getContent() {
  ...
  const sa = "scrollspy",
    jn = ".te.scrollspy",
    cb = ".data-api",
    ah = { offset: 10, method: "auto", target: "" },
    hb = { offset: "number", method: "string", target: "(string|element)" },
    db = {
      active:
    ...
    pb = `scroll${jn}`,
    _b = `load${jn}${cb}`,
    na = "data-te-nav-link-active",
    lh = "[data-te-dropdown-item-ref]",
    gb = '[data-te-spy="scroll"]',
    mb = "[data-te-nav-list-ref]",
    oa = "[data-te-nav-link-ref]",
    bb = "[data-te-nav-item-ref]",
    ch = "[data-te-list-group-item-ref]",
    ra = `${oa}, ${ch}, ${lh}`,
    vb = "[data-te-dropdown-ref]",
    yb = "[data-te-dropdown-toggle-ref]",
    xb = "offset",
    hh = "position";
  class Is extends Xt {
    constructor(t, e, s) {
      super(t),
        ...
        b.on(this._scrollElement, pb, () => this._process()),
        this.refresh(),
        this._process(),
        (this._didInit = !1),
        this._init();
    ...
    refresh() {
      const t = this._scrollElement === this._scrollElement.window ? xb : hh,
        e = this._config.method === "auto" ? t : this._config.method,
        s = e === hh ? this._getScrollTop() : 0;
      (this._offsets = []),
        (this._targets = []),
        (this._scrollHeight = this._getScrollHeight()),
        g
          .find(ra, this._config.target)
          .map((o) => {
            const r = yr(o),
              a = r ? g.findOne(r) : null;
            if (a) {
              const l = a.getBoundingClientRect();
              if (l.width || l.height) return [v[e](a).top + s, r];
            }
            return null;
          })
          .filter((o) => o)
    ...
    _getConfig(t) {
      return (
        ...
        (t.target = Le(t.target) || document.documentElement),
        W(sa, t, hb),
        t
      );
    }
  ...
  const dh = "tab",
    ...
    Tb = `show${Yn}`,
    Ab = `shown${Yn}`,
    wb = "data-te-dropdown-menu-ref",
    Yi = "data-te-tab-active",
    Kn = "data-te-nav-active",
    kb = "[data-te-dropdown-ref]",
    Sb = "[data-te-nav-ref]",
    uh = `[${Yi}]`,
    Ob = `[${Kn}]`,
    fh = ":scope > li > .active",
    Db = "[data-te-dropdown-toggle-ref]",
    Mb = ":scope > [data-te-dropdown-menu-ref] [data-te-dropdown-show]",
    Ib = { show: "opacity-100", hide: "opacity-0" },
    Lb = { show: "string", hide: "string" };
  class Un extends Xt {
    constructor(t, e) {
    ...
    show() {
      if (
        this._element.parentNode &&
        this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
        this._element.getAttribute(Kn) === ""
      )
        return;
      let t;
      const e = Ie(this._element),
        s = this._element.closest(Sb),
        n = g.findOne(Ob, s);
      if (s) {
        const l = s.nodeName === "UL" || s.nodeName === "OL" ? fh : uh;
        (t = g.find(l, s)), (t = t[t.length - 1]);
      }
      const o = t ? b.trigger(t, Eb, { relatedTarget: this._element }) : null;
      if (
        b.trigger(this._element, Tb, { relatedTarget: t }).defaultPrevented ||
        (o !== null && o.defaultPrevented)
      )
        return;
      this._activate(this._element, s, null, n, this._element);
      const a = () => {
        b.trigger(t, Cb, { relatedTarget: this._element }),
          b.trigger(this._element, Ab, { relatedTarget: t });
      };
      e ? this._activate(e, e.parentNode, a, n, this._element) : a();
    }
    _getClasses(t) {
      const e = v.getDataClassAttributes(this._element);
      return (t = { ...Ib, ...e, ...t }), W(dh, t, Lb), t;
    }
    _activate(t, e, s, n, o) {
      const a = (
        ...
        l = s && a && a.hasAttribute(Yi),
        c = () => this._transitionComplete(t, a, s, n, o);
      a && l
        ? (v.removeClass(a, this._classes.show),
          v.addClass(a, this._classes.hide),
    ...
    _transitionComplete(t, e, s, n, o) {
      ...
      t.setAttribute(Yi, ""),
        ...
        t.classList.contains(this._classes.hide) &&
          (v.removeClass(t, this._classes.hide),
          v.addClass(t, this._classes.show));
      let r = t.parentNode;
      if (
        ...
        a && g.find(Db, a).forEach((l) => l.setAttribute(Yi, "")),
  ...
  const aa = "toast",
    ...
    Fb = `show${$e}`,
    Vb = `shown${$e}`,
    ph = "data-te-toast-hide",
    la = "data-te-toast-show",
    Xn = "data-te-toast-showing",
    Wb = { animation: "boolean", autohide: "boolean", delay: "number" },
    _h = { animation: !0, autohide: !0, delay: 5e3 },
    zb = {
      fadeIn:
        "animate-[fade-in_0.3s_both] p-[auto] motion-reduce:transition-none motion-reduce:animate-none",
      fadeOut:
    ...
    jb = { fadeIn: "string", fadeOut: "string" };
  class Ls extends Xt {
    constructor(t, e, s) {
      super(t),
        (this._config = this._getConfig(e)),
    ...
    show() {
      ...
      const e = () => {
        this._element.removeAttribute(Xn),
          b.trigger(this._element, Vb),
          this._maybeScheduleHide();
      };
      this._element.removeAttribute(ph),
        Ii(this._element),
        this._element.setAttribute(la, ""),
        this._element.setAttribute(Xn, ""),
    ...
    hide() {
      if (
        ...
        b.trigger(this._element, Bb).defaultPrevented
      )
        return;
      const e = () => {
        let s = 0;
        this._config.animation &&
          ...
          v.addClass(this._element, this._classes.fadeOut)),
          setTimeout(() => {
            this._element.setAttribute(ph, ""),
              this._element.removeAttribute(Xn),
              this._element.removeAttribute(la),
              b.trigger(this._element, Hb);
          }, s);
      };
      this._element.setAttribute(Xn, ""),
        this._queueCallback(e, this._element, this._config.animation);
    ...
    _getConfig(t) {
      return (
        ...
        W(aa, t, this.constructor.DefaultType),
        t
      );
    }
    _getClasses(t) {
      const e = v.getDataClassAttributes(this._element);
      return (t = { ...zb, ...e, ...t }), W(aa, t, jb), t;
    }
    _maybeScheduleHide() {
    ...
    _setListeners() {
      b.on(this._element, Pb, (t) => this._onInteraction(t, !0)),
        b.on(this._element, Rb, (t) => this._onInteraction(t, !1)),
        b.on(this._element, Nb, (t) => this._onInteraction(t, !0)),
        b.on(this._element, $b, (t) => this._onInteraction(t, !1));
    }
    _clearTimeout() {
      clearTimeout(this._timeout), (this._timeout = null);
    }
        ...
        379: (s, n, o) => {
          ...
          function h(E, C) {
            for (var T = {}, A = [], w = 0; w < E.length; w++) {
              ...
              M !== -1
                ? (l[M].references++, l[M].updater(L))
                : l.push({ identifier: O, updater: x(L, C), references: 1 }),
                A.push(O);
            }
            return A;
          }
          ...
          function p(E, C, T, A) {
            ...
            if (E.styleSheet) E.styleSheet.cssText = f(C, w);
              ...
              var S = document.createTextNode(w),
                k = E.childNodes;
              k[C] && E.removeChild(k[C]),
                k.length ? E.insertBefore(S, k[C]) : E.appendChild(S);
            }
          }
          function _(E, C, T) {
            var A = T.css,
...
/*# sourceMappingURL=data:application/json;base64,`.concat(
  ...
  const ca = "input",
    Gn = "te.input",
    gh = "data-te-input-wrapper-init",
    mh = "data-te-input-notch-ref",
    bh = "data-te-input-notch-leading-ref",
    vh = "data-te-input-notch-middle-ref",
    Yb = "data-te-input-notch-trailing-ref",
    Kb = "data-te-input-helper-ref",
    Ub = "data-te-input-placeholder-active",
    Be = "data-te-input-state-active",
    yh = "data-te-input-focused",
  ...
  class Z {
    constructor(t, e, s) {
      (this._config = this._getConfig(e, t)),
        ...
        this._element && (P.setData(t, Gn, this), this.init());
    }
    static get NAME() {
      return ca;
    }
    get input() {
      return (
        g.findOne("input", this._element) ||
        g.findOne("textarea", this._element)
      );
    }
    init() {
      this._initiated ||
    ...
    forceActive() {
      this.input.setAttribute(Be, ""),
        g.findOne(Ki, this.input.parentNode).setAttribute(Be, "");
    }
    forceInactive() {
      this.input.removeAttribute(Be),
        g.findOne(Ki, this.input.parentNode).removeAttribute(Be);
    }
    dispose() {
      this._removeBorder(),
    ...
    _getCounter() {
      (this._counter = v.getDataAttribute(this.input, "inputShowcounter")),
        this._counter &&
          ((this._maxLength = this.input.maxLength), this._showCounter());
    }
    _getEvents() {
      b.on(document, "focus", fi, Z.activate(new Z())),
        b.on(document, "input", fi, Z.activate(new Z())),
        b.on(document, "blur", fi, Z.deactivate(new Z())),
        b.on(document, "focus", pi, Z.activate(new Z())),
        b.on(document, "input", pi, Z.activate(new Z())),
        b.on(document, "blur", pi, Z.deactivate(new Z())),
        b.on(window, "shown.te.modal", (t) => {
        ...
        b.on(window, "shown.te.tab", (t) => {
          ...
          t.target.href
            ...
            : (e = v.getDataAttribute(t.target, "target").split("#")[1]);
          const s = g.findOne(`#${e}`);
    ...
    _showCounter() {
      ...
      (this._counterElement = document.createElement("div")),
        v.addClass(this._counterElement, this._classes.counter),
    ...
    _getNotchData() {
      (this._notchMiddle = g.findOne(Ch, this._element)),
        (this._notchLeading = g.findOne(Eh, this._element));
    }
    _getLabelWidth() {
    ...
    _getLabelPositionInInputGroup() {
      if (
        ...
        return;
      const t = this.input,
        e = g.prev(t, "[data-te-input-group-text-ref]")[0];
      e === void 0
        ? (this._labelMarginLeft = 0)
    ...
    _applyDivs() {
      const t = this._config.inputFormWhite
        ...
        n = g.find(Ki, this._element),
        o = z("div");
      v.addClass(o, this._classes.notch),
        o.setAttribute(mh, ""),
        (this._notchLeading = z("div")),
        v.addClass(this._notchLeading, `${this._classes.notchLeading} ${t}`),
        this._notchLeading.setAttribute(bh, ""),
        (this._notchMiddle = z("div")),
        v.addClass(this._notchMiddle, `${this._classes.notchMiddle} ${e}`),
        this._notchMiddle.setAttribute(vh, ""),
        (this._notchTrailing = z("div")),
        v.addClass(this._notchTrailing, `${this._classes.notchTrailing} ${s}`),
        this._notchTrailing.setAttribute(Yb, ""),
        !(n.length >= 1) &&
    ...
    _activate(t) {
      Nl(() => {
        ...
        const e = t ? t.target : this.input,
          s = g.findOne(Ki, this._element);
        t && t.type === "focus" && s.setAttribute(yh, ""),
          e.value !== "" && (e.setAttribute(Be, ""), s.setAttribute(Be, "")),
    ...
    _getElements(t) {
      if (
        ...
        this._getLabelData(),
          e !== this._labelWidth &&
            ((this._notchMiddle = g.findOne(Ch, t.target.parentNode)),
            (this._notchLeading = g.findOne(Eh, t.target.parentNode)),
            this._applyNotch());
      }
    }
    _deactivate(t) {
      const e = t ? t.target : this.input,
        s = g.findOne(Ki, e.parentNode);
      s.removeAttribute(yh),
        e.value === "" && (e.removeAttribute(Be), s.removeAttribute(Be)),
        this._toggleDefaultDatePlaceholder(e);
    }
    static activate(t) {
      return function (e) {
  ...
  class qn {
    constructor(t, e) {
      (this._element = t),
        ...
        this._element && (P.setData(t, ha, this), this._init());
    }
    static get NAME() {
      return Th;
    }
    ...
    dispose() {
      b.off(this._element, "mousedown"),
        b.off(this._animateElement, "animationend"),
        b.off(window, "scroll"),
        b.off(this._element, "mouseover"),
        P.removeData(this._element, ha),
        (this._element = null),
    ...
    _getConfig(t) {
      ...
      return (t = { ...tv, ...e, ...t }), W(Th, t, Jb), t;
    }
    _animateOnScroll() {
      const t = v.offset(this._animateElement).top,
    ...
    _hideAnimateElement() {
      v.style(this._animateElement, { visibility: "hidden" });
    }
    _showAnimateElement() {
      v.style(this._animateElement, { visibility: "visible" });
    }
  ...
  class Ui {
    constructor(t, e, s) {
      (this._element = t),
        ...
        this._element &&
          (P.setData(t, Zn, this),
          v.addClass(this._element, this._classes.ripple)),
    ...
    dispose() {
      P.removeData(this._element, Zn),
        b.off(this._element, "click", this._clickHandler),
        (this._element = null),
        (this._options = null);
    }
    _autoInit(t) {
        ...
        (this._rippleTimer = setTimeout(() => {
          if (t && (t.remove(), this._element)) {
            g.find("[data-te-ripple-ref]", this._element).forEach((n) => {
              ...
              this._isMinWidthSet &&
                (v.style(this._element, { "min-width": "" }),
                (this._isMinWidthSet = !1));
    ...
    _getConfig(t = {}) {
      const e = v.getDataAttributes(this._element);
      return (t = { ...nv, ...e, ...t }), W(da, t, ov), t;
    }
    _getClasses(t) {
      const e = v.getDataClassAttributes(this._element);
      return (t = { ...rv, ...e, ...t }), W(da, t, av), t;
    }
    _getDiameter({ offsetX: t, offsetY: e, height: s, width: n }) {
      const o = e <= s / 2,
        r = t <= n / 2,
        a = (u, f) => Math.sqrt(u ** 2 + f ** 2),
        l = e === s / 2 && t === n / 2,
        c = {
          first: o === !0 && r === !1,
          second: o === !0 && r === !0,
    ...
    _toggleUnbound(t) {
      this._options.rippleUnbound === !0
        ? v.addClass(t, this._classes.unbound)
        : v.removeClass(t, this._classes.unbound);
    }
    _addColor(t) {
      ...
      const s = sv.find((r) => r.name === e.toLowerCase()),
        n = s
          ? this._colorToRGB(s.gradientColor).join(",")
          : this._colorToRGB(e).join(","),
        o = ev.split("{{color}}").join(`${n}`);
  ...
  const _v = "data-te-datepicker-modal-container-ref",
    gv = "data-te-datepicker-dropdown-container-ref",
    mv = "data-te-dropdown-backdrop-ref",
    bv = "data-te-datepicker-date-text-ref",
    Sh = "data-te-datepicker-view-ref",
    vv = "data-te-datepicker-previous-button-ref",
    yv = "data-te-datepicker-next-button-ref",
    xv = "data-te-datepicker-ok-button-ref",
    Ev = "data-te-datepicker-cancel-button-ref",
    Cv = "data-te-datepicker-clear-button-ref",
    Tv = "data-te-datepicker-view-change-button-ref";
  function Av(i, t, e, s, n, o, r, a, l, c) {
    ...
    return (
      n.inline
        ? (v.addClass(p, c.datepickerDropdownContainer),
          p.setAttribute(gv, l),
          (p.innerHTML = _))
        : (v.addClass(p, c.modalContainer),
          p.setAttribute(_v, l),
          (p.innerHTML = m)),
      p
    );
  ...
  function Mh(i, t, e, s) {
    ...
    <div class="${s.datepickerDateControls}">
      ...
      }" aria-label="${e.switchToMultiYearViewLabel}" ${Tv}>
        ${e.monthsFull[i]} ${t} ${de(e, s)}
      </button>
      <div class="${s.datepickerArrowControls}">
        <button class="${
          s.datepickerPreviousButton
        }" aria-label="${e.prevMonthLabel}" ${vv}>${e.changeMonthIconTemplate}</button>
        <button class="${
          s.datepickerNextButton
        }" aria-label="${e.nextMonthLabel}" ${yv}>${e.changeMonthIconTemplate}</button>
      </div>
    </div>
    `;
  }
  ...
  function Sv(i, t) {
    const e = `<button class="${t.datepickerFooterBtn}" aria-label="${i.okBtnLabel}" ${xv}>${i.okBtnText}</button>`,
      s = `<button class="${t.datepickerFooterBtn}" aria-label="${i.cancelBtnLabel}" ${Ev}>${i.cancelBtnText}</button>`,
      n = `<button class="${t.datepickerFooterBtn} ${t.datepickerClearBtn}" aria-label="${i.clearBtnLabel}" ${Cv}>${i.clearBtnText}</button>`;
    return `
          ...
          <tr>
            ${h
              .map((d) => {
                ...
                ${
                  kh(u, i, s.min, s.max, s.disablePast, s.disableFuture)
                    ? "data-te-datepicker-cell-disabled"
                    : ""
                }
        ...
        <tr>
          ${c
            .map(
              ...
              ${
                fa(h, e.min, e.max, e.disablePast, e.disableFuture)
                  ? "data-te-datepicker-cell-disabled"
                  : ""
              }
  ...
  const Zi = 37,
    ...
    Bv = `dateChange${ho}`,
    uo = `click${ho}${Rv}`,
    Ih = "data-te-datepicker-modal-container-ref",
    Lh = "data-te-datepicker-dropdown-container-ref",
    fo = "[data-te-datepicker-toggle-ref]",
    Hv = `[${Ih}]`,
    Fv = `[${Lh}]`,
    Vv = "[data-te-datepicker-view-change-button-ref]",
    Wv = "[data-te-datepicker-previous-button-ref]",
    zv = "[data-te-datepicker-next-button-ref]",
    jv = "[data-te-datepicker-ok-button-ref]",
    Yv = "[data-te-datepicker-cancel-button-ref]",
    Kv = "[data-te-datepicker-clear-button-ref]",
    Uv = "[data-te-datepicker-view-ref]",
    Xv = "[data-te-datepicker-toggle-button-ref]",
    Gv = "[data-te-datepicker-date-text-ref]",
    qv = "[data-te-dropdown-backdrop-ref]",
    Zv =
    ...
    o0 = "h-8 flex flex-col justify-end",
    r0 = "text-[10px] font-normal uppercase tracking-[1.7px] text-white",
    a0 = "xs:max-md:landscape:mt-24 h-[72px] flex flex-col justify-end",
    l0 = "text-[34px] font-normal text-white",
    c0 = "outline-none px-3",
    h0 = "px-3 pt-2.5 pb-0 flex justify-between text-black/[64]",
    d0 =
    ...
    _0 = "h-14 flex absolute w-full bottom-0 justify-end items-center px-3",
    g0 =
    ...
    m0 = "mr-auto",
    b0 = "w-10 h-10 text-center text-[12px] font-normal dark:text-white",
    v0 =
    ...
    y0 = "w-10 h-10 xs:max-md:landscape:w-8 xs:max-md:landscape:h-8",
    x0 = "w-[76px] h-[42px]",
    E0 =
    ...
    C0 = "w-9 h-9 leading-9 rounded-[50%] text-[13px]",
    T0 = "w-[72px] h-10 leading-10 py-[1px] px-0.5 rounded-[999px]",
    A0 = "mx-auto w-[304px]",
    w0 =
  ...
  class Ph {
    constructor(t, e, s) {
      (this._element = t),
        (this._input = g.findOne("input", this._element)),
        (this._options = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        ...
        (this._isOpen = !1),
        (this._toggleButtonId = se("datepicker-toggle-")),
        (this._animations =
          !window.matchMedia("(prefers-reduced-motion: reduce)").matches &&
          this._options.animations),
        (this._scrollBar = new Es()),
        this._element && P.setData(t, co, this),
        this._init(),
        this.toggleButton &&
    ...
    get container() {
      return (
        g.findOne(`[${Ih}='${this._toggleButtonId}']`) ||
        g.findOne(`[${Lh}='${this._toggleButtonId}']`)
      );
    }
    get options() {
    ...
    open() {
      ...
      const e = wv(this._classes.datepickerBackdrop),
        s = Av(
          this._activeDate,
          this._selectedDate,
          this._selectedYear,
      ...
      this._options.inline
        ...
        this._animations &&
          (v.addClass(this.container, this._classes.fadeIn),
          v.addClass(e, this._classes.fadeInShort)),
    ...
    _openDropdown(t) {
      (this._popper = Fi(this._input, t, { placement: "bottom-start" })),
    ...
    _updateHeaderDate(t, e, s) {
      const n = g.findOne(Gv, this.container),
        o = ot(t),
        r = bt(t),
        a = Jn(t);
    ...
    _listenToFooterButtonsClick() {
      b.on(this.okButton, "click", () => this.handleOk()),
        b.on(this.cancelButton, "click", () => this.handleCancel()),
        b.on(this.clearButton, "click", () => this.handleClear());
    }
    ...
    _handleDaysViewKeydown(t) {
      ...
      switch (t.keyCode) {
        ...
        case ts:
          this._activeDate = Gi(
            this._activeDate,
            ua(this._activeDate) - bt(this._activeDate)
          );
          break;
        case pa:
    ...
    close() {
      ...
      !this._isOpen ||
        ...
        this._animations && v.addClass(this.container, this._classes.fadeOut),
    ...
    _closeModal() {
      const t = g.findOne(qv),
        e = g.findOne(Hv);
      !e ||
        !t ||
        (this._animations
          ? (v.addClass(t, this._classes.fadeOutShort),
            t.addEventListener("animationend", () => {
    ...
    _removeDatepickerListeners() {
      b.off(this.nextButton, "click"),
        b.off(this.previousButton, "click"),
        b.off(this.viewChangeButton, "click"),
        b.off(this.okButton, "click"),
        b.off(this.cancelButton, "click"),
        b.off(this.clearButton, "click"),
        b.off(this.datesContainer, "click"),
        b.off(this.datesContainer, "keydown"),
        b.off(this.datesContainer, "focus"),
        b.off(this.datesContainer, "blur"),
        b.off(document, uo);
    }
    dispose() {
    ...
    _removeInputAndToggleListeners() {
      b.off(this._input, "input"),
        b.off(this._element, uo, fo),
        b.off(this._element, "keydown", fo);
    }
    handleOk() {
    ...
    _confirmSelection(t) {
      if (t) {
        ...
        (this._input.value = e),
          b.trigger(this._element, Bv, { date: t }),
    ...
    formatDate(t) {
      const e = bt(t),
        ...
        n = this._options.weekdaysShort[Jn(t)],
        o = this._options.weekdaysFull[Jn(t)],
        r = ot(t) + 1,
    ...
    nextMonth() {
      const t = Ct(this._activeDate, 1),
        e = io(t, this._headerDate, this._options, this._classes);
      (this._activeDate = t),
    ...
    _changeView(t) {
      (this._view = t),
        ...
        t === "days" &&
          (this.datesContainer.innerHTML = io(
            this._activeDate,
            this._headerDate,
            this._options,
            this._classes
        ...
        t === "months" &&
          (this.datesContainer.innerHTML = so(
            this.activeYear,
            this._selectedYear,
            this._selectedMonth,
            this._options,
    ...
    _parseDate(t, e, s) {
      ...
      for (let _ = 0; _ < a.length; _++)
        a[_].indexOf("yy") !== -1 && (c[0] = { value: r[_], format: a[_] }),
          a[_].indexOf("m") !== -1 && (c[1] = { value: r[_], format: a[_] }),
          a[_].indexOf("d") !== -1 &&
            a[_].length <= 2 &&
            (c[2] = { value: r[_], format: a[_] });
      let h;
      e.indexOf("mmmm") !== -1
...
`;
    ...
    po = "data-te-timepicker-disabled",
    _o = "data-te-timepicker-active",
    gi = (i) => {
      if (i === "") return;
      let t, e, s, n;
      return (
    ...
    R0 = (i, t, e) =>
      b.on(document, i, t, ({ target: s }) => {
        if (s.hasAttribute(_o)) return;
        document.querySelectorAll(t).forEach((o) => {
          o.hasAttribute(_o) &&
            (v.removeClass(o, e.opacity), o.removeAttribute(_o));
        }),
          v.addClass(s, e.opacity),
          s.setAttribute(_o, "");
      }),
    ...
    He = (i, t, e) => {
      ...
      let s = Hh();
      return (
        e && (s = `${gi(s).hours}:${gi(s).minutes} ${gi(s).amOrPm}`),
        ((i !== "" && Bh(s, i)) || i === "") && (i = s),
        i
      );
    },
    ...
    N0 = (
      ...
      const [l, c, h] = j(t, !1),
        [d, u, f] = j(e, !1);
      if (h !== void 0 || f !== void 0) return [r, a];
      if (
      ...
      i.forEach((n) => {
        (t = t === "12" && s ? "0" : t),
          (n.textContent === "00" ||
            ...
            (v.addClass(n, e.tipsDisabled), n.setAttribute(po, ""));
      });
    },
    Vh = (i, t, e, s) => {
      i.forEach((n) => {
    ...
    $0 = (i, t, e, s, n, o) => {
      i.forEach((r) => {
        (Wh(s, e, o, "max") ||
          ...
          (v.addClass(r, n.tipsDisabled), r.setAttribute(po, ""));
      });
    },
    B0 = (i, t, e, s, n, o) => {
      i.forEach((r) => {
    ...
    H0 = (i) => (i.startsWith("0") ? Number(i.slice(1)) : Number(i)),
    Ns = "timepicker",
    H = `data-te-${Ns}`,
    zh = "[data-te-toggle]",
    mo = `te.${Ns}`,
    ...
    va = `${H}-icon-up`,
    ya = `${H}-icon-down`,
    Y0 = `${H}-icon-inline-hour`,
    K0 = `${H}-icon-inline-minute`,
    td = `${H}-inline-hour-icons`,
    U0 = `${H}-current-inline`,
    X0 = "readonly",
    ed = `${H}-invalid-feedback`,
    xa = `${H}-is-invalid`,
    Ve = `${H}-disabled`,
    J = `${H}-active`,
    G0 = `${H}-input`,
  ...
  class od {
    constructor(t, e = {}, s) {
      ...
      Ee(this, "_toggleBackgroundColorCircle", (t) => {
        if (this._modal.querySelector(`${t}[${J}]`) !== null) {
          v.addStyle(this._circle, { backgroundColor: "#1976d2" });
          return;
        }
        v.addStyle(this._circle, { backgroundColor: "transparent" });
      });
      ...
      Ee(this, "_getAppendClock", (t = [], e = `[${mi}]`, s) => {
        ...
        !r &&
          ...
          (v.addClass(this._PM, this._classes.opacity),
        ...
        if (m === null) return;
        const E = (m.offsetWidth - 32) / 2,
          C = (m.offsetHeight - 32) / 2,
          T = E - 4;
        setTimeout(() => {
          let A;
          a && (A = g.findOne(`${yo}[${J}]`).textContent),
            this._handleDisablingTipsMinTime(A, _, p, f),
          ...
          [...t].forEach((A, w) => {
            const S = x(w * y),
              ...
              D = z("span");
            (D.innerHTML = A),
              v.addClass(k, this._classes.tips),
              k.setAttribute(s, "");
      ...
      (this._element = t),
        this._element && P.setData(t, mo, this),
        (this._document = document),
        (this._options = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        (this._currentTime = null),
        (this._toggleButtonId = se("timepicker-toggle-")),
        (this.hoursArray = [
          "12",
          "1",
          "2",
        ...
        (this.input = g.findOne("input", this._element)),
        (this.dataWithIcon = t.dataset.withIcon),
        (this.dataToggle = t.dataset.toggle),
        (this.customIcon = g.findOne(z0, this._element)),
        this._checkToggleButton(),
        (this.inputFormatShow = g.findOne(W0, this._element)),
        (this.inputFormat =
          this.inputFormatShow === null
            ? ""
            : Object.values(this.inputFormatShow.dataset)[0]),
        (this.elementToggle = g.findOne(zh, this._element)),
        (this.toggleElement = Object.values(t.querySelector(zh).dataset)[0]),
        (this._hour = null),
        (this._minutes = null),
        (this._AM = null),
        (this._PM = null),
        ...
        this._options.format24 &&
          ...
          (this._currentTime = Nh(this._inputValue))),
        this._options.format12 &&
          ((this._options.format24 = !1),
          (this._currentTime = gi(this._inputValue))),
        this._options.readOnly && this.input.setAttribute(X0, !0),
    ...
    init() {
      ...
      this.input.value.length > 0 &&
        this.input.value !== "" &&
        (this.input.setAttribute(J, ""), b.trigger(this.input, "input")),
    ...
    dispose() {
      this._removeModal(),
        this._element !== null && P.removeData(this._element, mo),
        setTimeout(() => {
          (this._element = null),
            (this._options = null),
            (this.input = null),
    ...
    _getDomElements() {
      (this._hour = g.findOne(`[${xo}]`)),
        (this._minutes = g.findOne(`[${Ca}]`)),
        (this._AM = g.findOne(F0)),
        (this._PM = g.findOne(V0)),
        (this._wrapper = g.findOne(`[${Ea}]`)),
        (this._modal = g.findOne(`[${nd}]`)),
        (this._hand = g.findOne(`[${Ta}]`)),
        (this._circle = g.findOne(`[${Aa}]`)),
        (this._clock = g.findOne(`[${mi}]`)),
        (this._clockInner = g.findOne(`[${$s}]`));
    }
    _handlerMaxMinHoursOptions(t, e, s, n, o, r) {
      ...
      const {
        ...
        f = r.keyCode,
        p =
          r.target.hasAttribute($s) ||
          r.target.hasAttribute(Rt) ||
          r.target.hasAttribute(Co);
      (s = He(s, c, l)),
        (e = Fe(e, h, l)),
      ...
      const y = () => {
          const w = document.querySelectorAll(`[${Eo}]`),
            S = document.querySelectorAll(`[${Co}]`),
            k = H0(this._hour.innerText);
          let D, O, M;
          return (
            f === Tt ? (O = 1) : f === ut && (O = -1),
            k === 12 && f === Tt
    ...
    _handleKeyboard() {
      b.on(this._document, bo, "", (t) => {
        ...
        const _ = g.findOne(`[${vt}]`) === null,
          m = g.findOne(`[${Rt}]`) !== null,
          y = Number(this._hand.style.transform.replace(/[^\d-]/g, "")),
          x = g.find(`[${vt}]`, this._modal),
          E = g.find(`[${ft}]`, this._modal),
          C = g.find(`[${Rt}]`, this._modal);
        ...
        if (t.keyCode === ro) {
          ...
          if (
            (m &&
              (t.keyCode === Qi &&
                ((this._isInner = !1),
                v.addStyle(this._hand, { height: "calc(40% + 1px)" }),
                (this._hour.textContent = this._setHourOrMinute(
                  T > 12 ? 1 : T
                )),
                this._toggleClassActive(this.hoursArray, this._hour, E),
                this._toggleClassActive(this.innerHours, this._hour, C)),
              t.keyCode === Zi &&
                ((this._isInner = !0),
                v.addStyle(this._hand, { height: "21.5%" }),
                (this._hour.textContent = this._setHourOrMinute(
                  O >= 24 || O === "00" ? 0 : O
                )),
                this._toggleClassActive(this.innerHours, this._hour, C),
            ...
            v.addStyle(this._hand, { transform: `rotateZ(${A + w}deg)` }),
              this._isInner
                ? ((O += 1),
          ...
          t.keyCode === Tt &&
            ((k += D),
            v.addStyle(this._hand, { transform: `rotateZ(${k}deg)` }),
            (S += 1),
            o && ((S += 4), S === "0014" && (S = 5)),
            ...
            (n) => (
              n === "PM"
                ? (v.addClass(this._PM, this._classes.opacity),
                  this._PM.setAttribute(J, ""))
                : n === "AM"
                ? (v.addClass(this._AM, this._classes.opacity),
                  this._AM.setAttribute(J, ""))
                : (v.removeClass(this._AM, this._classes.opacity),
                  v.removeClass(this._PM, this._classes.opacity),
    ...
    _setTipsAndTimesDependOnInputValue(t, e) {
      ...
      if (this._isInvalidTimeFormat)
        (this._hour.textContent = "12"),
          ...
          s || v.addStyle(this._hand, { transform: "rotateZ(0deg)" }),
          n &&
            (v.addClass(this._PM, this._classes.opacity),
            this._PM.setAttribute(J, ""));
      else {
        ...
        (this._hour.textContent = t),
          ...
          s ||
            (v.addStyle(this._hand, { transform: `rotateZ(${o}deg)` }),
            v.addStyle(this._circle, { backgroundColor: "#1976d2" }),
            (Number(t) > 12 || t === "00") &&
              v.addStyle(this._hand, { height: "21.5%" }));
      }
    ...
    _listenToToggleKeydown() {
      b.on(
        ...
        (t) => {
          t.keyCode === Pt &&
            (t.preventDefault(), b.trigger(this.elementToggle, "click"));
        }
      );
    }
    _handleOpen() {
      ...
      si.on(
        ...
        (e) => {
          ...
          setTimeout(() => {
            v.addStyle(this.elementToggle, { pointerEvents: "none" }),
            ...
            if (
              ...
              this.input.blur(),
              e.target.blur(),
              (d.innerHTML = L0(this._options, this._classes)),
              v.addClass(d, this._classes.modal),
              d.setAttribute(nd, ""),
              d.setAttribute("role", "dialog"),
              d.setAttribute("tabIndex", "-1"),
              d.setAttribute("id", o),
              r
                ? ((this._popper = Fi(this.input, d, {
              ...
              this._animations
                ...
                : v.addClass(this._wrapper, this._classes.opacity),
            ...
            if (
              ...
              v.addClass(u, this._classes.opacity),
                v.addStyle(this._hour, { pointerEvents: "none" }),
                v.addStyle(this._minutes, { pointerEvents: "" });
            }
    ...
    _handleInlineClicks() {
      ...
      si.on(
        ...
        (u) => {
          ...
          const { target: f, type: p } = u,
            _ = p === "mousedown" || p === "touchstart";
          f.closest(`[${va}]`)
            ? f.closest(`[${va}]`).parentNode.hasAttribute(td)
              ? _
                ? d(a)
                : p === "mouseup" || p === "touchend" || p === "contextmenu"
                ? clearInterval(this._interval)
                : a()
              : _
              ? d(l)
              ...
              : l()
            : f.closest(`[${ya}]`) &&
              (f.closest(`[${ya}]`).parentNode.hasAttribute(td)
                ? _
                  ? d(c)
                  : p === "mouseup" || p === "touchend"
                  ? clearInterval(this._interval)
                  : c()
                : _
                ? d(h)
        ...
        b.on(window, bo, (u) => {
          const f = u.code,
            p = document.activeElement.hasAttribute(xo),
            _ = document.activeElement.hasAttribute(Ca),
            m = document.activeElement === document.body;
          switch (
            ((t = Number(this._hour.textContent)),
            (e = Number(this._minutes.textContent)),
            f)
      ...
      b.on(
        ...
        ({ target: t }) => {
          const { closeModalOnBackdropClick: e } = this._options,
            s = () => {
              var n;
              v.addStyle(this.elementToggle, { pointerEvents: "auto" }),
    ...
    _handleOkButton() {
      si.on(this._modal, "click", `[${ba}]`, () => {
        ...
        (e !== "" &&
          ((w && (C || k)) || (E === "PM" && c.textContent === "AM"))) ||
          (N0(this._options, this.input, this._hour.textContent) !== void 0 &&
            (this._isInvalidTimeFormat && this.input.removeAttribute(xa),
            ...
            this._animations && this._toggleBackdropAnimation(!0),
            this._removeModal(),
            b.trigger(this.input, "input.te.timepicker"),
            b.trigger(this.input, "input")));
      });
    }
    _handleHoverInlineBtn() {
      si.on(
        ...
        `[${U0}]`,
        ({ type: t, target: e }) => {
          const s = g.find(`[${Y0}]`, this._modal),
            n = g.find(`[${K0}]`, this._modal),
            o = (l, c) =>
              l.forEach((h) => {
                if (c) {
    ...
    _handleSwitchHourMinute() {
      R0("click", vo, this._classes),
        b.on(this._modal, "click", vo, () => {
          const { format24: t } = this._options,
            e = g.find(vo, this._modal),
            s = g.find(`[${vt}]`, this._modal),
            n = g.find(`[${ft}]`, this._modal),
            o = g.find(`[${Rt}]`, this._modal),
            r = Number(this._hour.textContent),
            a = Number(this._minutes.textContent),
            l = (c, h) => {
              n.forEach((u) => u.remove()),
                s.forEach((u) => u.remove()),
                v.addClass(this._hand, this._classes.transform),
                setTimeout(() => {
                  v.removeClass(this._hand, this._classes.transform);
                }, 401),
                this._getAppendClock(c, `[${mi}]`, h);
              const d = () => {
                const u = g.find(`[${ft}]`, this._modal),
                  f = g.find(`[${vt}]`, this._modal);
                this._addActiveClassToTip(u, r),
                  this._addActiveClassToTip(f, a);
              };
              if (!t)
                setTimeout(() => {
                  d();
                  ...
                  Number(this._hour.textContent) > 12
                    ? (v.addStyle(this._hand, {
                      ...
                      Number(this._hour.textContent) > 12 &&
                        v.addStyle(this._hand, { height: "21.5%" }))
                    : v.addStyle(this._hand, { height: "calc(40% + 1px)" }),
                  t && this._getAppendClock(this.innerHours, `[${$s}]`, Rt),
                  o.length > 0 && o.forEach((h) => h.remove()),
                  l(this.hoursArray, ft),
                  v.addStyle(this._hour, { pointerEvents: "none" }),
                  v.addStyle(this._minutes, { pointerEvents: "" })));
          });
        });
    ...
    _handleDisablingTipsMaxTime(t, e, s, n) {
      ...
      const o = g.find(`[${ft}]`),
        ...
        a = g.find(`[${vt}]`);
      if (!e || e === t) {
        Fh(r, n, this._classes, this._options.format12),
          Fh(o, n, this._classes, this._options.format12),
          $0(
            a,
            s,
            n,
    ...
    _handleDisablingTipsMinTime(t, e, s, n) {
      ...
      const o = g.find(`[${ft}]`),
        ...
        a = g.find(`[${vt}]`);
      !e || e === t
        ? (Vh(o, n, this._classes, this._options.format12),
          Vh(r, n, this._classes, this._options.format12),
          B0(
            a,
            s,
            n,
      ...
      b.on(document, "click", yo, ({ target: t }) => {
        ...
        (() => {
          f.forEach((m) => {
            ...
            p.forEach((m) => {
              v.removeClass(m, this._classes.tipsDisabled),
                m.removeAttribute(Ve);
            });
        })(),
          ...
          t.hasAttribute(J) ||
            (g.find(yo).forEach((y) => {
              y.hasAttribute(J) &&
                (v.removeClass(y, this._classes.opacity), y.removeAttribute(J));
            }),
            v.addClass(t, this._classes.opacity),
            t.setAttribute(J, ""));
      });
    }
    _handleClockClick() {
      ...
      si.on(
        document,
        `${Yh} ${Kh} ${Uh} ${Xh} ${Gh} ${Qh} ${qh} ${Zh}`,
        "",
        (d) => {
          go() || d.preventDefault();
          const { type: u, target: f } = d,
            { closeModalOnMinutesClick: p, switchHoursToMinutesOnClick: _ } =
              this._options,
            m = g.findOne(`[${vt}]`, this._modal) !== null,
            y = g.findOne(`[${ft}]`, this._modal) !== null,
            x = g.findOne(`[${Rt}]`, this._modal) !== null,
            E = g.find(`[${vt}]`, this._modal),
            C = $h(d, h),
            T = h.offsetWidth / 2;
          ...
          if (m) {
            ...
            const O = Math.trunc((A * 180) / Math.PI) + 90,
              { degrees: M, minute: L } = this._makeMinutesDegrees(O, D);
            if (this._handlerMaxMinMinutesOptions(M, L) === void 0) return;
            const { degrees: X, minute: I } = this._handlerMaxMinMinutesOptions(
              M,
              L
            );
            if (this._isMouseMove) {
              if (
                (v.addStyle(this._hand, { transform: `rotateZ(${X}deg)` }),
                I === void 0)
              )
                return;
              const F = () => (I >= 10 || I === "00" ? I : `0${I}`);
              (this._minutes.textContent = F()),
                this._toggleClassActive(this.minutesArray, this._minutes, E),
                this._toggleBackgroundColorCircle(`[${vt}]`),
                (this._objWithDataOnChange.degreesMinutes = X),
                (this._objWithDataOnChange.minutes = I);
            }
          }
          if (y || x) {
            let D,
            ...
            if (
              ...
              v.addStyle(this._circle, { backgroundColor: "#1976d2" }),
              this._makeHourDegrees(f, O, D) === void 0)
            )
              return;
            const M = () => {
              if (go() && O && k) {
            ...
            (this._objWithDataOnChange.degreesHours = O),
              this._handlerMaxMinHoursOptions(O, l, c, r, a, d) && M();
          }
          d.stopPropagation();
        }
      );
    ...
    _handleMoveHand(t, e, s) {
      const n = g.find(`[${ft}]`, this._modal),
        o = g.find(`[${Rt}]`, this._modal);
      this._isMouseMove &&
        (this._hasTargetInnerClass(t)
          ? v.addStyle(this._hand, { height: "21.5%" })
          : v.addStyle(this._hand, { height: "calc(40% + 1px)" }),
        v.addStyle(this._hand, { transform: `rotateZ(${s}deg)` }),
    ...
    _handlerMaxMinMinutesOptions(t, e) {
      ...
      if (!_ && !m) {
        if (s !== "" && n !== "") {
          if ((Number(p) === C && t > y) || (Number(f) === C && t < x))
            return t;
    ...
    _toggleBackdropAnimation(t = !1) {
      t
        ...
        : (this._wrapper.classList.add("animate-[fade-in_350ms_ease-in-out]"),
          this._options.inline ||
            v.addClass(this._clock, this._classes.clockAnimation)),
        setTimeout(() => {
    ...
    _addActiveClassToTip(t, e) {
      t.forEach((s) => {
        Number(s.textContent) === Number(e) &&
          (v.addClass(s, this._classes.tipsActive), s.setAttribute(J, ""));
      });
    }
    _setHourOrMinute(t) {
      return t < 10 ? `0${t}` : t;
    ...
    _appendTimes() {
      ...
      if (t) {
        this._getAppendClock(this.hoursArray, `[${mi}]`, ft),
          this._getAppendClock(this.innerHours, `[${$s}]`, Rt);
        return;
      }
      this._getAppendClock(this.hoursArray, `[${mi}]`, ft);
    }
    _getConfig(t) {
      const e = v.getDataAttributes(this._element);
      return (t = { ...q0, ...e, ...t }), W(Ns, t, Z0), t;
    }
    _getClasses(t) {
      const e = v.getDataClassAttributes(this._element);
      return (t = { ...Q0, ...e, ...t }), W(Ns, t, J0), t;
    }
    _getContainer() {
      return g.findOne(this._options.container);
    }
    _getValidate(t) {
      ...
      let r;
      o && ((r = z("div")), r.setAttribute(ed, ""), (r.innerHTML = e)),
        si.on(this.input, t, ({ target: a }) => {
          ...
          if ((c.test(a.value) !== !0 && s) || (h !== !0 && n)) {
            o &&
              (this.input.setAttribute(xa, ""),
              this.input.parentNode.insertBefore(r, this.input.nextSibling)),
              v.addStyle(a, { marginBottom: 0 }),
              v.addStyle(r, { bottom: "-23px" }),
  ...
  function ey(i, t, e, s, n) {
    ...
    (i.reach[l] = null),
      ...
      t &&
        (d.dispatchEvent(Ao("ps-scroll-" + l)),
        t < 0
          ? d.dispatchEvent(Ao("ps-scroll-" + c))
          : t > 0 && d.dispatchEvent(Ao("ps-scroll-" + h)),
        s && ty(i, l)),
      i.reach[l] &&
        (t || n) &&
        d.dispatchEvent(Ao("ps-" + l + "-reach-" + i.reach[l]));
  }
  function it(i) {
  ...
  function iy(i) {
    return (
      We(i, "input,[contenteditable]") ||
      We(i, "select,[contenteditable]") ||
      We(i, "textarea,[contenteditable]") ||
      We(i, "button,[contenteditable]")
    );
  }
  function sy(i) {
    var t = pe(i);
  ...
  function Ce(i) {
    ...
    (i.containerWidth = Math.round(s.width)),
      ...
      t.contains(i.scrollbarXRail) ||
        (ad(t, at.element.rail("x")).forEach(function (n) {
          return es(n);
        }),
        t.appendChild(i.scrollbarXRail)),
      t.contains(i.scrollbarYRail) ||
        (ad(t, at.element.rail("y")).forEach(function (n) {
          return es(n);
        }),
  ...
  function fd(i, t) {
    ...
    function m() {
      hd(i, c),
        ...
        i.event.unbind(i.ownerDocument, "mousemove", _);
    }
    function y(x, E) {
      (u = d[l]),
        ...
        (p = (i[s] - i[e]) / (i[o] - i[a])),
        E
          ? i.event.bind(i.ownerDocument, "touchmove", _)
          : (i.event.bind(i.ownerDocument, "mousemove", _),
  ...
  function ly(i) {
    ...
    function e(r, a) {
      var l = Math.floor(t.scrollTop),
        ...
        f;
      return (
        Math.abs(a) > Math.abs(r) ? (f = c || h) : (f = d || u),
        f ? !i.settings.wheelPropagation : !0
      );
    }
    function s(r) {
      var a = r.deltaX,
  ...
  function cy(i) {
    ...
    var t = i.element;
    function e(p, _) {
      var m = Math.floor(t.scrollTop),
        y = t.scrollLeft,
        x = Math.abs(p),
        E = Math.abs(_);
      if (E > x) {
        if (
          (_ < 0 && m === i.contentHeight - i.containerHeight) ||
          (_ > 0 && m === 0)
        )
          return window.scrollY === 0 && _ > 0 && ss.isChrome;
    ...
    function d(p, _, m) {
      ...
      for (var y = p; y && y !== t; ) {
        ...
        if (m && x.overflowY.match(/(scroll|auto)/)) {
          ...
          if (
            E > 0 &&
            ((y.scrollTop > 0 && m < 0) || (y.scrollTop < E && m > 0))
          )
            return !0;
        }
        if (_ && x.overflowX.match(/(scroll|auto)/)) {
          ...
          if (
            C > 0 &&
            ((y.scrollLeft > 0 && _ < 0) || (y.scrollLeft < C && _ > 0))
          )
            return !0;
        }
        y = y.parentNode;
    ...
    function u(p) {
      if (c(p)) {
        ...
        var E = new Date().getTime(),
          C = E - o;
        C > 0 && ((r.x = y / C), (r.y = x / C), (o = E)),
          e(y, x) && p.preventDefault();
      }
    }
    function f() {
  ...
  var hy = function () {
    ...
    Hs = function (t, e) {
      ...
      (this.isRtl = pe(t).direction === "rtl"),
        ...
        (this.scrollbarXRail = To(at.element.rail("x"))),
        t.appendChild(this.scrollbarXRail),
        (this.scrollbarX = To(at.element.thumb("x"))),
      ...
      (this.scrollbarXBottom = parseInt(a.bottom, 10)),
        ...
        (this.scrollbarYRail = To(at.element.rail("y"))),
        t.appendChild(this.scrollbarYRail),
        (this.scrollbarY = To(at.element.thumb("y"))),
      ...
      (this.scrollbarYRight = parseInt(l.right, 10)),
        ...
        (this.scrollbarYOuterWidth = this.isRtl ? sy(this.scrollbarY) : null),
  ...
  (Hs.prototype.update = function () {
    this.isAlive &&
      ...
      (this.railXMarginWidth =
        it(pe(this.scrollbarXRail).marginLeft) +
        it(pe(this.scrollbarXRail).marginRight)),
      (this.railYMarginHeight =
        it(pe(this.scrollbarYRail).marginTop) +
        it(pe(this.scrollbarYRail).marginBottom)),
    ...
    (Hs.prototype.onScroll = function (t) {
      this.isAlive &&
        (Ce(this),
        wo(this, "top", this.element.scrollTop - this.lastScrollTop),
        wo(this, "left", this.element.scrollLeft - this.lastScrollLeft),
    ...
    (Hs.prototype.destroy = function () {
      this.isAlive &&
        ...
        es(this.scrollbarX),
        es(this.scrollbarY),
        es(this.scrollbarXRail),
        es(this.scrollbarYRail),
  ...
  const uy = { threshold: 10, direction: "all" };
  class fy {
    constructor(t, e) {
      (this._element = t),
    ...
    handleTouchMove(t) {
      ...
      if (this._options.direction === "all") {
        ...
        b.trigger(this._element, `swipe${r}`),
          b.trigger(this._element, "swipe", { direction: r }),
          (this._startPosition = null);
        return;
      }
      const o =
      ...
      n[o].direction === this._options.direction &&
        ...
        (b.trigger(this._element, `swipe${n[o].direction}`),
        (this._startPosition = null));
    }
    handleTouchEnd() {
      this._startPosition = null;
  ...
  const _y =
    ...
    yy = (i = document) => {
      [
        { ps: "ps__rail-x", te: gy },
        { ps: "ps__rail-y", te: by },
        { ps: "ps__thumb-x", te: my },
        { ps: "ps__thumb-y", te: vy },
      ].forEach((e) => {
        v.addClass(g.findOne(`.${e.ps}`, i), e.te),
          v.removeClass(g.findOne(`.${e.ps}`, i), e.ps);
      }),
        v.addClass(i, _y),
        v.removeClass(i, "ps");
    },
    pd = "sidenav",
    ko = "te.sidenav",
    xy = "data-te-sidenav-rotate-icon-ref",
    wa = "[data-te-sidenav-toggle-ref]",
    Ey = "[data-te-collapse-init]",
    Cy = '[data-te-sidenav-slim="true"]',
    Ty = '[data-te-sidenav-slim="false"]',
    Ay = "[data-te-sidenav-menu-ref]",
    ns = "[data-te-sidenav-collapse-ref]",
    Fs = "[data-te-sidenav-link-ref]",
    wy = st() ? 100 : -100,
    ky = st() ? -100 : 100,
    Sy = {
  ...
  class bi {
    constructor(t, e = {}) {
      Ee(this, "_addBackdropOnInit", () => {
        this._options.sidenavHidden ||
          (this._backdrop.show(),
          b.off(this._element, "transitionend", this._addBackdropOnInit));
      });
      (this._element = t),
        (this._options = e),
        (this._ID = se("")),
        ...
        (this.escHandler = (s) => {
          s.keyCode === ro &&
            this.toggler &&
            ne(this.toggler) &&
            (this._update(!1), b.off(window, "keydown", this.escHandler));
        }),
        (this.hashHandler = () => {
          this._setActiveElements();
        }),
        t && (P.setData(t, ko, this), this._setup()),
        this.options.sidenavBackdrop &&
          !this.options.sidenavHidden &&
          this.options.sidenavMode === "over" &&
          b.on(this._element, "transitionend", this._addBackdropOnInit),
        (this._didInit = !1),
        this._init();
    }
    static get NAME() {
    ...
    dispose() {
      b.off(window, "keydown", this.escHandler),
        this.options.sidenavBackdrop && this._backdrop.dispose(),
        b.off(window, "hashchange", this.hashHandler),
        this._touch.dispose(),
        P.removeData(this._element, ko),
        (this._element = null);
    }
    hide() {
      this._emitEvents(!1),
    ...
    _init() {
      this._didInit ||
        (b.on(document, "click", wa, bi.toggleSidenav()), (this._didInit = !0));
    }
    ...
    _handleSwipe(t, e) {
      ...
      this.options.sidenavExpandable
        ...
        : e ||
          ...
          !this.options.sidenavSlim ||
          !this.options.sidenavExpandable
            ? this.toggler && ne(this.toggler) && this.toggle()
            : this.toggleSlim());
    }
    _isActive(t, e) {
      return e
    ...
    _setupActiveState() {
      this._setActiveElements(),
        this.links.forEach((t) => {
          b.on(t, "click", () => this._setActiveElements(t)),
            b.on(t, "keydown", (e) => {
    ...
    _setupCollapseList({ list: t, index: e, menu: s, menuIndex: n }) {
      ...
      const [r] = g.prev(t, Fs);
      v.setDataAttribute(r, "collapse-init", ""),
      ...
      (t.dataset.teSidenavStateShow === "" ||
        ...
        b.on(t, "show.te.collapse", () => this._rotateArrow(r, !1)),
        b.on(t, "hide.te.collapse", () => this._rotateArrow(r, !0)),
        b.on(t, "shown.te.collapse", () => {
          this.options.sidenavMode === "over" &&
            this._focusTrap &&
            this._focusTrap.update();
        }),
    ...
    _setupContent() {
      (this._content = g.find(this.options.sidenavContent)),
    ...
    _setupScrolling() {
      ...
      if (this.options.sidenavScrollContainer) {
        ...
        const s = qp(t.parentNode.children)
          .filter((n) => n !== t)
          .reduce((n, o) => n + o.clientHeight, 0);
        v.style(t, { maxHeight: `calc(100% - ${s}px)`, position: "relative" });
      }
      ...
      this.links.forEach((t) => {
        ...
        (localStorage.theme === "dark" ||
          (!("theme" in localStorage) &&
            window.matchMedia("(prefers-color-scheme: dark)").matches)) &&
          (s = "white"),
          (e = new Ui(t, { rippleColor: s }));
      });
    }
    _setupTouch() {
      (this._touch = new py(this._element, "swipe", { threshold: 20 })),
        this._touch.init(),
        b.on(this._element, "swipeleft", (t) =>
          this._handleSwipe(t, this.options.sidenavRight)
        ),
        b.on(this._element, "swiperight", (t) =>
          this._handleSwipe(t, !this.options.sidenavRight)
        );
    }
    _setActive(t, e) {
      ...
      this._setActiveCategory(n),
        !e && !this._slimCollapsed && re.getInstance(s).show();
    }
    ...
    _setContentOffsets(t, e, s) {
      this._content.forEach((n, o) => {
        ...
        if (
          ...
          if (s) {
            v.style(n, { transition: this._initialContentStyle[o].transition });
            return;
          }
    ...
    _setSlim(t) {
      ...
      this._triggerEvents(...e),
        ...
        v.style(this._element, { width: `${this.width}px` }),
    ...
    _toggleSlimDisplay(t) {
      const e = g.find(Cy, this._element),
        s = g.find(Ty, this._element),
        n = () => {
          e.forEach((o) => {
            v.style(o, { display: this._slimCollapsed ? "unset" : "none" });
          }),
            s.forEach((o) => {
              v.style(o, { display: this._slimCollapsed ? "none" : "unset" });
            });
        };
      t ? setTimeout(() => n(), this.options.sidenavTransitionDuration) : n();
    }
    async _triggerEvents(t, e) {
      b.trigger(this._element, `${t}.te.sidenav`),
        e &&
          (await setTimeout(() => {
    ...
    _update(t) {
      this.toggler && this._updateTogglerAria(t),
        ...
        t &&
          ...
          b.on(window, "keydown", this.escHandler),
        this.options.sidenavFocusTrap && this._updateFocus(t);
    }
    _updateDisplay(t) {
      const e = t ? 0 : this.translation;
      v.style(this._element, { transform: `translateX(${e}%)` });
    }
    _updateFocus(t) {
      if (
        (this._setTabindex(t),
    ...
    _updateOffsets(t, e = !1) {
      ...
      b.trigger(this._element, "update.te.sidenav", { margin: r, padding: o }),
        this._content &&
    ...
    static toggleSidenav() {
      return function (t) {
        const e = g.closest(t.target, wa),
          s = v.getDataAttributes(e).target;
        g.find(s).forEach((n) => {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        if (
          !(!s && /dispose/.test(t)) &&
          (s || (s = new bi(this, n)), typeof t == "string")
        ) {
          if (typeof s[t] > "u") throw new TypeError(`No method named "${t}"`);
          s[t](e);
        }
  ...
  class vd {
    constructor(t, e) {
      (this._element = t),
        ...
        (this._steps = g.find(`${ze}`, this._element)),
        (this._currentView = ""),
        (this._activeStepIndex = 0),
        (this._verticalStepperStyles = []),
        this._element && (P.setData(t, So, this), this._init());
    }
    static get NAME() {
      return ka;
    }
    ...
    _init() {
      const t = g
          .find(`${ze}`, this._element)
          [this._activeStepIndex].setAttribute("data-te", "active-step"),
        e = g.find(`${bd}`, this._element),
        s = g.find(`${Do}`, this._element);
      switch (
        (t
    ...
    _getConfig(t) {
      const e = v.getDataAttributes(this._element);
      return (t = { ...My, ...e, ...t }), W(ka, t, Dy), t;
    }
    _bindMouseDown() {
      this._steps.forEach((t) => {
        const e = g.findOne(`${yt}`, t);
        b.on(e, _d, (s) => {
          const n = g.parents(s.target, `${ze}`)[0],
    ...
    _bindResize() {
      b.on(window, md, () => {
        this._currentView === _e && this._setSingleStepHeight(this.activeStep),
          this._currentView === Ws && this._setHeight(this.activeStep),
          (this._options.stepperVerticalBreakpoint ||
            this._options.stepperMobileBreakpoint) &&
            this._toggleStepperView();
      });
    ...
    _toggleStepperView() {
      ...
      t && this._currentView !== Ws && this._toggleHorizontal(),
        e &&
          !s &&
    ...
    _toggleStepperClass() {
      g.findOne("[data-te-stepper-type]", this._element) !== null &&
        this._steps.forEach((e) => {
          g.findOne(`${wt}`, e).classList.remove("!my-0"),
            g.findOne(`${wt}`, e).classList.remove("!py-0"),
            g.findOne(`${wt}`, e).classList.remove("!h-0");
        });
    }
    ...
    _bindKeysNavigation() {
      this._toggleStepTabIndex(!1, g.findOne(`${yt}`, this.activeStep)),
        this._steps.forEach((t) => {
          const e = g.findOne(`${yt}`, t);
          b.on(e, gd, (s) => {
            const n = g.parents(s.currentTarget, `${ze}`)[0],
              o = g.next(n, `${ze}`)[0],
              r = g.prev(n, `${ze}`)[0],
              a = g.findOne(`${yt}`, n),
              l = g.findOne(`${yt}`, this.activeStep);
            let c = null,
              h = null;
            if (
              (o && (c = g.findOne(`${yt}`, o)),
            ...
            b.on(e, Iy, (s) => {
              const n = g.parents(s.currentTarget, `${ze}`)[0],
                o = g.findOne(`${yt}`, n),
                r = g.findOne(`${yt}`, this.activeStep);
              s.keyCode === Rs &&
    ...
    _toggleDisabled() {
      const t = g.find(`${yt}`, this._element),
        e = g.find(`${Do}`, this._element);
    ...
    _toggleActive(t) {
      const e = g.find(`${bd}`, this._element),
        s = g.find(`${Do}`, this._element);
    ...
    _hideElement(t) {
      (!g.parents(t, `${ze}`)[0].getAttribute("data-te") &&
        this._currentView !== _e) ||
    ...
    _animateHorizontalStep(t) {
      const e = t > this._activeStepIndex,
        s = g.findOne(`${wt}`, this._steps[t]),
        n = g.findOne(`${wt}`, this.activeStep);
      let o, r;
    ...
    _animateVerticalStep(t) {
      const e = g.findOne(`${wt}`, this._steps[t]),
        s = g.findOne(`${wt}`, this.activeStep);
  ...
  const yd = "data-te-input-state-active",
    Mo = "data-te-input-selected",
    xd = "data-te-input-multiple-active",
    Ed = "[data-te-form-check-input]";
  class Cd {
    ...
    removeActiveStyles() {
      this.active && ((this.active = !1), this.node.removeAttribute(yd)),
        this.multiple && this.node.removeAttribute(xd);
    }
  }
  class Ly {
    constructor(t = !1) {
  ...
  const Py = "data-te-select-form-outline-ref",
    Ry = "data-te-select-wrapper-ref",
    Ny = "data-te-select-input-ref",
    $y = "data-te-select-clear-btn-ref",
    By = "data-te-select-dropdown-container-ref",
    Hy = "data-te-select-dropdown-ref",
    Fy = "data-te-select-options-wrapper-ref",
    Vy = "data-te-select-options-list-ref",
    Wy = "data-te-select-input-filter-ref",
    Td = "data-te-select-option-ref",
    zy = "data-te-select-option-all-ref",
    jy = "data-te-select-option-text-ref",
    Yy = "data-te-form-check-input",
    Ky = "data-te-select-option-group-ref",
    Uy = "data-te-select-option-group-label-ref",
    Ad = "data-te-select-selected",
    Xy = `
...
`,
  ...
  function Io(i, t, e, s, n) {
    t.selectSize === "default" && v.addClass(i, e),
      t.selectSize === "sm" && v.addClass(i, s),
      t.selectSize === "lg" && v.addClass(i, n);
  }
  function qy(i, t, e, s) {
    ...
    r.setAttribute(Ny, ""),
      ...
      t.selectFormWhite && v.addClass(r, s.selectInputWhite),
    ...
    const p = z("span");
    p.setAttribute($y, ""),
      v.addClass(p, s.selectClearBtn),
      Io(p, t, s.selectClearBtnDefault, s.selectClearBtnSm, s.selectClearBtnLg),
      t.selectFormWhite && v.addClass(p, s.selectClearBtnWhite);
    const _ = document.createTextNode("✕");
    p.appendChild(_), p.setAttribute("tabindex", "0");
    const m = z("span");
    return (
      v.addClass(m, s.selectArrow),
      Io(m, t, s.selectArrowDefault, s.selectArrowSm, s.selectArrowLg),
      t.selectFormWhite && v.addClass(m, s.selectArrowWhite),
      (m.innerHTML = Xy),
      o.appendChild(r),
      e &&
        (v.addClass(e, s.selectLabel),
        Io(
          e,
          t,
        ...
        t.selectFormWhite && v.addClass(e, s.selectLabelWhite),
        o.appendChild(e)),
      t.selectValidation && (o.appendChild(h), o.appendChild(u)),
      t.selectClearButton && o.appendChild(p),
      o.appendChild(m),
      n.appendChild(o),
      n
    );
  ...
  function wd(i, t, e, s, n, o, r, a) {
    ...
    l.setAttribute(By, ""),
      v.addClass(l, a.selectDropdownContainer),
      l.setAttribute("id", `${i}`),
      (l.style.width = `${e}px`);
    const c = document.createElement("div");
    c.setAttribute("tabindex", 0),
      c.setAttribute(Hy, ""),
      v.addClass(c, a.dropdown);
    const h = z("div");
    h.setAttribute(Fy, ""),
      v.addClass(h, a.optionsWrapper),
      v.addClass(h, a.optionsWrapperScrollbar),
      (h.style.maxHeight = `${s}px`);
    const d = kd(o, n, t, a);
    return (
      h.appendChild(d),
      t.selectFilter && c.appendChild(Zy(t.selectSearchPlaceholder, a)),
      c.appendChild(h),
      r && c.appendChild(r),
      l.appendChild(c),
      l
  ...
  function kd(i, t, e, s) {
    ...
    let o;
    return (
      e.multiple ? (o = Jy(i, t, e, s)) : (o = Qy(i, e, s)),
      o.forEach((r) => {
        n.appendChild(r);
      }),
      n
  ...
  function Zy(i, t) {
    ...
    return (
      s.setAttribute(Wy, ""),
      v.addClass(s, t.selectFilterInput),
      (s.placeholder = i),
  ...
  function tx(i, t, e, s) {
    ...
    return (
      o.setAttribute(Td, ""),
      v.addClass(o, s.selectOption),
      o.setAttribute(zy, ""),
      v.addStyle(o, { height: `${e.selectOptionHeight}px` }),
      o.setAttribute("role", "option"),
      o.setAttribute("aria-selected", n),
      n && o.setAttribute(Ad, ""),
      o.appendChild(Dd(i, e, s)),
      i.setNode(o),
      o
    );
  }
  function Od(i, t, e) {
    ...
    return (
      s.setAttribute(Td, ""),
      v.addClass(s, e.selectOption),
      v.addStyle(s, { height: `${t.selectOptionHeight}px` }),
      v.setDataAttribute(s, "id", i.id),
      s.setAttribute("role", "option"),
      s.setAttribute("aria-selected", i.selected),
      s.setAttribute("aria-disabled", i.disabled),
      i.selected && s.setAttribute(Ad, ""),
      i.disabled && s.setAttribute("data-te-select-option-disabled", !0),
      i.hidden && v.addClass(s, "hidden"),
      s.appendChild(Dd(i, t, e)),
      i.icon && s.appendChild(sx(i, e)),
      i.setNode(s),
      s
    );
  }
  function Dd(i, t, e) {
    ...
    return (
      t.multiple && s.appendChild(ix(i, e)),
      s.appendChild(n),
      (i.secondaryText || typeof i.secondaryText == "number") &&
        s.appendChild(ex(i.secondaryText, e)),
      s
    );
  }
  function ex(i, t) {
  ...
  function sx(i, t) {
    const e = z("span"),
      s = z("img");
    return (
      v.addClass(s, t.selectOptionIcon), (s.src = i.icon), e.appendChild(s), e
    );
  }
  function nx(i, t, e) {
    const s = z("div");
    s.setAttribute(Ky, ""),
      v.addClass(s, e.selectOptionGroup),
    ...
    return (
      n.setAttribute(Uy, ""),
      v.addClass(n, e.selectOptionGroupLabel),
      v.addStyle(n, { height: `${t.selectOptionHeight}px` }),
  ...
  function ox(i, t) {
    ...
    return (
      (e.innerHTML = i),
      v.addClass(e, t.selectLabel),
      v.addClass(e, t.selectFakeValue),
      e
    );
  }
  const Oa = "select",
    ...
    ax = `open${js}`,
    Md = `optionSelect${js}`,
    Id = `optionDeselect${js}`,
    lx = `valueChange${js}`,
    cx = "change",
    Ld = "data-te-select-init",
    Pd = "data-te-select-no-results-ref",
    Rd = "data-te-select-open",
    xt = "data-te-input-state-active",
    je = "data-te-input-focused",
    Da = "data-te-input-disabled",
    hx = "data-te-select-option-group-label-ref",
    dx = "data-te-select-option-all-ref",
    Ys = "data-te-select-selected",
    ux = "[data-te-select-label-ref]",
    Nd = "[data-te-select-input-ref]",
    fx = "[data-te-select-input-filter-ref]",
    px = "[data-te-select-dropdown-ref]",
    _x = "[data-te-select-options-wrapper-ref]",
    $d = "[data-te-select-options-list-ref]",
    gx = "[data-te-select-option-ref]",
    mx = "[data-te-select-clear-btn-ref]",
    bx = "[data-te-select-custom-content-ref]",
    vx = `[${Pd}]`,
    Bd = "[data-te-select-form-outline-ref]",
    yx = "[data-te-select-toggle]",
    Ma = "[data-te-input-notch-ref]",
    xx = 200,
    Ex = {
      selectAutoSelect: !1,
  ...
  class Lo {
    constructor(t, e, s) {
      (this._element = t),
        ...
        (this._selectionModel = new Ly(this.multiple)),
        (this._activeOptionIndex = -1),
        (this._activeOption = null),
        (this._wrapperId = se("select-wrapper-")),
        (this._dropdownContainerId = se("select-dropdown-container-")),
        (this._selectAllId = se("select-all-")),
        (this._debounceTimeoutId = null),
        (this._dropdownHeight =
          this._config.selectOptionHeight * this._config.selectVisibleOptions),
        (this._popper = null),
        (this._input = null),
        (this._label = g.next(this._element, ux)[0]),
        (this._notch = null),
        (this._fakeValue = null),
        (this._isFakeValueActive = !1),
        (this._customContent = g.next(t, bx)[0]),
        ...
        this._element && P.setData(t, zs, this);
    }
    static get NAME() {
      return Oa;
    }
    ...
    _createOptionObject(t, e = {}) {
      const s = se("option-"),
        ...
        r = t.selected || t.hasAttribute(Ys),
        a = t.hasAttribute("disabled") || o,
        l = t.hasAttribute("hidden") || (e && e.hidden),
        c = this.multiple,
        h = t.value,
        d = t.label,
        u = v.getDataAttribute(t, "selectSecondaryText"),
        f = v.getDataAttribute(t, "select-icon");
    ...
    _init() {
      this._renderMaterialWrapper(),
        (this._wrapper = g.findOne(`#${this._wrapperId}`)),
        (this._input = g.findOne(Nd, this._wrapper)),
        this._config.disabled && this._input.setAttribute(Da, "");
      const t = this._config.selectContainer;
      t === "body"
        ? (this._container = document.body)
        : (this._container = g.findOne(t)),
    ...
    _renderMaterialWrapper() {
      ...
      this._element.parentNode.insertBefore(t, this._element),
        v.addClass(this._element, this._classes.initialized),
        t.appendChild(this._element);
    }
    _initOutlineInput() {
      const t = g.findOne(Bd, this._wrapper);
      new Z(t, { inputFormWhite: this._config.selectFormWhite }).init(),
        (this._notch = g.findOne(Ma, this._wrapper));
    }
    ...
    _handleClosedKeydown(t) {
      const e = t.keyCode;
      if (
        (e === Pt && t.preventDefault(),
        (e === Pt || (e === ut && t.altKey) || (e === ut && this.multiple)) &&
          this.open(),
        this.multiple)
      )
        switch (e) {
    ...
    _listenToOptionsClick() {
      b.on(this.optionsWrapper, "click", (t) => {
        ...
        const s =
          t.target.nodeName === "DIV" ? t.target : g.closest(t.target, gx);
    ...
    _singleOptionSelect(t) {
      ...
      e &&
        ...
        e.deselect(),
        e.node.setAttribute(Ys, !1),
        b.trigger(this._element, Id, { value: e.value })),
        (!e || (e && t !== e)) &&
          (this._selectionModel.select(t),
          t.select(),
          t.node.setAttribute(Ys, !0),
          b.trigger(this._element, Md, { value: t.value }),
          this._emitValueChangeEvent(this.value),
          this._emitNativeChangeEvent());
    }
    _handleMultiSelection(t) {
      t.selected
        ? (this._selectionModel.deselect(t),
          t.deselect(),
          t.node.setAttribute(Ys, !1),
          b.trigger(this._element, Id, { value: t.value }))
        : (this._selectionModel.select(t),
          t.select(),
          t.node.setAttribute(Ys, !0),
          b.trigger(this._element, Md, { value: t.value })),
    ...
    _emitValueChangeEvent(t) {
      b.trigger(this._element, lx, { value: t });
    }
    ...
    _appendFakeValue() {
      ...
      (this._fakeValue = ox(t, this._classes)),
        g.findOne(Bd, this._wrapper).appendChild(this._fakeValue);
    }
    _updateLabelPosition() {
      const t = this._element.hasAttribute(Ld),
        e = this._input.value !== "";
      this._label &&
    ...
    _updateClearButtonVisibility() {
      ...
      this._selectionModel.selection ||
      this._selectionModel.selections.length > 0
        ? v.addStyle(this.clearButton, { display: "block" })
        : v.addStyle(this.clearButton, { display: "none" });
    }
    ...
    _updateDropdownWidth() {
      ...
      v.addStyle(this._dropdownContainer, { width: `${t}px` });
    }
    ...
    _setInputActiveStyles() {
      this._input.setAttribute(je, ""),
        g.findOne(Ma, this._wrapper).setAttribute(je, "");
    }
    ...
    _updateOptionsListTemplate(t) {
      const e =
          g.findOne($d, this._dropdownContainer) ||
          g.findOne(vx, this._dropdownContainer),
        s = kd(t, this._selectAllOption, this._config, this._classes);
    ...
    _listenToOutsideClick() {
      (this._outsideClick = this._handleOutSideClick.bind(this)),
        b.on(document, "click", this._outsideClick);
    }
    _listenToFocusChange(t = !0) {
      if (t === !1) {
        b.remove(this._input, "focus", () => this._notch.setAttribute(je, "")),
          b.remove(this._input, "blur", () => this._notch.removeAttribute(je));
        return;
      }
      b.on(this._input, "focus", () => this._notch.setAttribute(je, "")),
        b.on(this._input, "blur", () => this._notch.removeAttribute(je));
    }
    _handleOutSideClick(t) {
      ...
      let o;
      this._toggleButton || (this._elementToggle = g.find(yx)),
        this._elementToggle &&
    ...
    close() {
      ...
      !this._isOpen ||
        ...
        this.dropdown.removeAttribute(Rd),
        setTimeout(() => {
          this._input.removeAttribute(je),
            this._input.blur(),
            g.findOne(Ma, this._wrapper).removeAttribute(je),
            this._label &&
              !this.hasSelection &&
              (this._label.removeAttribute(xt),
        ...
        setTimeout(() => {
          this._container &&
            ...
            (this._isOpen = !1),
            b.off(this.dropdown, "transitionend");
        }, xx));
    }
    _resetFilterState() {
    ...
    _removeDropdownEvents() {
      b.off(document, "click", this._outsideClick),
        this._config.selectFilter && b.off(this.dropdown, "keydown"),
        b.off(this.optionsWrapper, "click");
    }
    ...
    dispose() {
      this._removeComponentEvents(),
        ...
        P.removeData(this._element, zs);
    }
    _removeComponentEvents() {
      b.off(this.input, "click"),
        b.off(this.wrapper, this._handleKeydown.bind(this)),
        b.off(this.clearButton, "click"),
        b.off(this.clearButton, "keydown"),
        b.off(window, "resize", this._handleWindowResize.bind(this));
    }
    ...
    _destroyMaterialTemplate() {
      ...
      t.appendChild(this._element),
        ...
        v.removeClass(this._element, this._classes.initialized),
        this._element.removeActiveStyles(Ld),
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        ...
        if (
          !(!s && /dispose/.test(t)) &&
          (s || (s = new Lo(this, n)), typeof t == "string")
        ) {
          if (typeof s[t] > "u") throw new TypeError(`No method named "${t}"`);
          s[t](e);
        }
  ...
  const wx = (i) => {
    ...
    Sx = (i, t) => {
      b.on(document, `click.te.${i.NAME}.data-api`, t, function (e) {
        if (
          (["A", "AREA"].includes(this.tagName) && e.preventDefault(), ei(this))
        )
          return;
    ...
    Ye = { plugins: { legend: { labels: { color: "rgb(102,102,102)" } } } },
    Po = {
      line: {
        options: {
          ...Ye,
    ...
    Ks = {
      ...
      chart: {
        ...
        advanced: (i, t) => {
          ...
          g.find(t).forEach((o) => {
            if (
              v.getDataAttribute(o, "chart") !== "bubble" &&
              v.getDataAttribute(o, "chart") !== "scatter"
            ) {
              const r = v.getDataAttributes(o),
                a = { data: { datasets: [n(r)] } };
              return (
        ...
        if (!!document.body.querySelector(Ks[s].selector)) {
          ...
          return (
            !o &&
              ...
              t &&
              console.warn(
                `Please import ${Ks[s].name} from "tw-elements" package and add it to a object parameter inside "initTE" function`
              ),
            o
          );
        }
    ...
    jx = { text: "", closeIcon: !1, img: { path: "", alt: "" }, iconSVG: Wx },
    Yx = {
    ...
    Kx = { icon: "string", chipElement: "string", chipCloseIcon: "string" };
  class vi {
    constructor(t, e = {}, s) {
      (this._element = t),
        (this._options = this._getConfig(e)),
    ...
    _handleClickOnChip() {
      b.on(this._element, "click", (t) => {
        const { textContent: e } = t.target,
          s = {};
        (s.tag = e.trim()), b.trigger(Vx, { event: t, obj: s });
      });
    }
    _handleDelete() {
      g.find(La, this._element).length !== 0 &&
        b.on(this._element, "click", La, () => {
    ...
    _getConfig(t) {
      const e = { ...jx, ...v.getDataAttributes(this._element), ...t };
      return W(Ro, e, zx), e;
    }
    _getClasses(t) {
      const e = v.getDataClassAttributes(this._element);
      return (t = { ...Yx, ...e, ...t }), W(Ro, t, Kx), t;
    }
    static getInstance(t) {
  ...
  const Us = "chips",
    ...
    Wd = `${Xs}-placeholder`,
    Xx = `${Xs}-input-wrapper`,
    Pa = "data-te-chip-init",
    zd = "data-te-chip-close",
    jd = "data-te-chip-text",
    Gx = `[${Bt}]`,
    Ra = `[${Pa}]`,
    qx = `${Ra}${Gx}`,
    Na = `[${zd}]`,
    ...
    Qx = `[${jd}]`,
    Jx = `[${Wd}]`,
    tE = "data-te-input-notch-leading-ref",
    eE = "data-te-input-notch-middle-ref",
    iE = `[${tE}]`,
    sE = `[${eE}]`,
    os = "data-te-input-state-active",
    $a = "[data-te-input-notch-ref]",
    nE = "add.te.chips",
    oE = "arrowDown.te.chips",
    rE = "arrowLeft.te.chips",
    aE = "arrowRight.te.chips",
    lE = "arrowUp.te.chips",
    Yd = "delete.te.chips",
    Kd = "select.te.chips",
    cE = {
  ...
  class Ud extends vi {
        ...
        e.value.length > 0 && this._handleCreateChip(e, e.value),
          this.allChips.length > 0
            ? (e.setAttribute(Bt, ""),
              ...
              g.findOne($a, this.input.parentNode).setAttribute(os, ""),
            ...
            : (e.removeAttribute(Bt),
              ...
              g.findOne($a, this.input.parentNode).removeAttribute(os),
              this.chipsInputWrapper.classList.remove(
                ...this._classes.inputWrapperPadding.split(" ")
              )),
          this.allChips.forEach((s) => s.removeAttribute(Bt));
      });
      (this._element = e),
        (this._label = null),
        (this._labelWidth = 0),
        ...
        (this._notchLeading = null),
        (this._notchMiddle = null),
        this._element && P.setData(e, Fd, this),
    ...
    _getNotchData() {
      (this._notchMiddle = g.findOne(sE, this._element)),
        (this._notchLeading = g.findOne(iE, this._element));
    }
    _getLabelData() {
      this._label = g.findOne("label", this._element);
    }
        ...
        this.allChips.forEach((s) => {
          b.on(s, "dblclick", (n) => {
            ...
            s.classList.add(...this._classes.contentEditable.split(" ")),
              ...
              s.focus(),
              setTimeout(() => {
                v.addStyle(o, { display: "none" });
              }, 200),
              o.classList.add(...this._classes.opacity.split(" ")),
              n.target.textContent,
              b.trigger(s, Kd, { event: n, allChips: this.allChips });
          }),
    ...
    _handleEvents(e, s) {
      const n = this._handleTextContent(),
        o = this.allChips.filter((r) => r.hasAttribute(Bt) && r);
    ...
    _handleInputText() {
      ...
      b.on(this._element, "keyup", e, (s) => this._handleKeysInputToElement(s)),
        b.on(this.input, "blur", (s) => this._handleBlurInput(s));
    }
    ...
    _handleCreateChip(e, s) {
      const n = z("div"),
        o = vi.getInstance(n),
        r = new vi(o, { text: s }, this._classes);
    ...
    _handleChipsOnSelect() {
      this.allChips.forEach((e) => {
        b.on(this._element, "click", (s) => {
          b.trigger(e, Kd, { event: s, allChips: this.allChips });
        });
      });
    }
    ...
    _getConfig(e) {
      const s = { ...hE, ...v.getDataAttributes(this._element), ...e };
      return W(Us, s, cE), s;
    }
    _getClasses(e) {
      const s = v.getDataClassAttributes(this._element);
      return (e = { ...dE, ...s, ...e }), W(Us, e, uE), e;
    }
  ...
  var gE = typeof Symbol == "function" && Symbol.for,
    mE = gE ? Symbol.for("react.element") : 60103;
  function bE(i) {
    return i.$$typeof === mE;
  }
  function vE(i) {
  ...
  function TE(i, t, e) {
    ...
    return (
      e.isMergeableObject(i) &&
        Xd(i).forEach(function (n) {
          s[n] = Gs(i[n], e);
        }),
      Xd(t).forEach(function (n) {
        CE(i, n) ||
          (Gd(i, n) && e.isMergeableObject(t[n])
            ? (s[n] = xE(n, e)(i[n], t[n], e))
            : (s[n] = Gs(t[n], e)));
      }),
      s
    );
  ...
  function rs(i, t, e) {
    (e = e || {}),
      (e.arrayMerge = e.arrayMerge || yE),
      (e.isMergeableObject = e.isMergeableObject || fE),
      (e.cloneUnlessOtherwiseSpecified = Gs);
  ...
  let Qd = class Yp {
    ...
    update(t, e) {
      t &&
        ...
        (this._chart.options = Ba(this._chart.options, this._options)),
        this._chart.update();
    }
    _getDarkConfig(t) {
      let e = {};
      ...
      return (t = { ...e, options: { ...l }, ...t }), W(qd, t, SE), t;
    }
    _chartConstructor() {
      if (this._data) {
        this._createCanvas();
        const t = Zd(this._options, this._type, Po),
          e = [];
        t.dataLabelsPlugin && e.push(this._ChartDataLabels),
    ...
    _changeDatasetBorderColor(t = !0) {
      [...this._data.data.datasets].forEach(
        (e) =>
          ...
          (e.borderColor = t ? this._darkOptions.darkBgColor : "#fff")
      );
    }
  ...
  function IE(i, t, e) {
    ...
    $(s) && $(n)
      ? qs(s, n)
      : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Bo(n));
  }
  const eu = { "": (i) => i, x: (i) => i.x, y: (i) => i.y };
  function Ke(i, t) {
  ...
  const we = (i, t, e, s) =>
      Wa(i, e, s ? (n) => i[n][t] <= e : (n) => i[n][t] < e),
    WE = (i, t, e) => Wa(i, e, (s) => i[s][t] >= e);
  function zE(i, t, e) {
    let s = 0,
      n = i.length;
    for (; s < n && i[s] < t; ) s++;
  ...
  const lu = ["push", "pop", "shift", "splice", "unshift"];
  function jE(i, t) {
    if (i._chartjs) {
  ...
  const za = (i) => (i === "start" ? "left" : i === "end" ? "right" : "center"),
    pt = (i, t, e) => (i === "start" ? t : i === "end" ? e : (t + e) / 2),
    KE = (i, t, e, s) =>
    ...
    if (i._sorted) {
      ...
      d &&
        (n = ct(
          Math.min(
            we(a, r.axis, c).lo,
            e ? s : we(t, l, r.getPixelForValue(c)).lo
          ),
          0,
          s - 1
        )),
        u
          ? (o =
              ct(
                Math.max(
                  we(a, r.axis, h, !0).hi + 1,
                  e ? 0 : we(t, l, r.getPixelForValue(h), !0).hi + 1
                ),
                n,
                s
              ) - n)
  ...
  const Fo = (i) => i === 0 || i === 1,
    ...
    gu = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * q) / e) + 1,
    tn = {
      linear: (i) => i,
      easeInQuad: (i) => i * i,
      easeOutQuad: (i) => -i * (i - 2),
      ...
      easeInElastic: (i) => (Fo(i) ? i : _u(i, 0.075, 0.3)),
      easeOutElastic: (i) => (Fo(i) ? i : gu(i, 0.075, 0.3)),
      easeInOutElastic(i) {
        return Fo(i)
          ? i
          : i < 0.5
          ? 0.5 * _u(i * 2, 0.1125, 0.45)
          : 0.5 + 0.5 * gu(i * 2 - 1, 0.1125, 0.45);
      },
      easeInBack(i) {
      ...
      easeInOutBounce: (i) =>
        i < 0.5
          ? tn.easeInBounce(i * 2) * 0.5
          : tn.easeOutBounce(i * 2 - 1) * 0.5 + 0.5,
    };
  /*!
   * @kurkle/color v0.2.1
  ...
  const Wt = {
    ...
    ja = [..."0123456789ABCDEF"],
    UE = (i) => ja[i & 15],
    XE = (i) => ja[(i & 240) >> 4] + ja[i & 15],
    Vo = (i) => (i & 240) >> 4 === (i & 15),
    GE = (i) => Vo(i.r) && Vo(i.g) && Vo(i.b) && Vo(i.a);
  function qE(i) {
    var t = i.length,
      e;
    return (
  ...
  let Wo;
  function cC(i) {
    Wo || ((Wo = lC()), (Wo.transparent = [0, 0, 0, 0]));
  ...
  function dC(i) {
    ...
    if (t) {
      ...
      return (
        ...
        (n = +t[3]),
        (o = +t[5]),
        (s = 255 & (t[2] ? sn(s) : Xe(s, 0, 255))),
        (n = 255 & (t[4] ? sn(n) : Xe(n, 0, 255))),
        (o = 255 & (t[6] ? sn(o) : Xe(o, 0, 255))),
        { r: s, g: n, b: o, a: e }
      );
    }
  }
  function uC(i) {
    return (
      i &&
      (i.a < 255
        ? `rgba(${i.r}, ${i.g}, ${i.b}, ${ke(i.a)})`
        : `rgb(${i.r}, ${i.g}, ${i.b})`)
    );
  }
  const Xa = (i) =>
      i <= 0.0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055,
    ls = (i) => (i <= 0.04045 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4));
  function fC(i, t, e) {
    const s = ls(ke(i.r)),
      n = ls(ke(i.g)),
      o = ls(ke(i.b));
    ...
    return (
      Array.isArray(i)
        ? i.length >= 3 &&
          ...
          i.length > 3 && (t.a = Ge(i[3])))
        : ((t = Eu(i, { r: 0, g: 0, b: 0, a: 1 })), (t.a = Ge(t.a))),
      t
    );
  }
  function pC(i) {
  ...
  function Ga(i) {
    return Au(i) ? i : Tu(i).saturate(0.5).darken(0.1).hexString();
  }
  ...
  class _C {
    constructor(t) {
      (this.animation = void 0),
        ...
        (this.hover = {}),
        (this.hoverBackgroundColor = (e, s) => Ga(s.backgroundColor)),
        (this.hoverBorderColor = (e, s) => Ga(s.borderColor)),
        (this.hoverColor = (e, s) => Ga(s.color)),
        (this.indexAxis = "x"),
        (this.interaction = {
          mode: "nearest",
          intersect: !0,
  ...
  function mC(i, t, e, s) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < a; l++)
      if (((d = e[l]), d != null && Q(d) !== !0)) r = Yo(i, n, o, r, d);
      else if (Q(d))
        for (c = 0, h = d.length; c < h; c++)
          (u = d[c]), u != null && !Q(u) && (r = Yo(i, n, o, r, u));
    i.restore();
    const f = o.length / 2;
    if (f > e.length) {
  ...
  function Su(i, t, e, s, n) {
    ...
    if (!(isNaN(f) || f <= 0)) {
      switch ((i.beginPath(), d)) {
        default:
          n ? i.ellipse(e, s, n / 2, f, 0, 0, q) : i.arc(e, s, f, 0, q),
            i.closePath();
          break;
        case "triangle":
          i.moveTo(e + Math.sin(p) * f, s - Math.cos(p) * f),
            (p += su),
            i.lineTo(e + Math.sin(p) * f, s - Math.cos(p) * f),
            (p += su),
            i.lineTo(e + Math.sin(p) * f, s - Math.cos(p) * f),
            i.closePath();
          break;
        case "rectRounded":
          (c = f * 0.516),
            ...
            (r = Math.cos(p + Zs) * l),
            (a = Math.sin(p + Zs) * l),
            i.arc(e - r, s - a, c, p - et, p - nt),
            i.arc(e + a, s - r, c, p - nt, p),
            i.arc(e + r, s + a, c, p, p + nt),
            i.arc(e - a, s + r, c, p + nt, p + et),
            i.closePath();
          break;
        case "rect":
          if (!u) {
  ...
  function Ei(i, t, e, s, n, o = {}) {
    ...
    let l, c;
    for (i.save(), i.font = n.string, yC(i, o), l = 0; l < r.length; ++l)
      (c = r[l]),
        a &&
  ...
  const EC = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
    CC = new RegExp(
  ...
  function Ja(i, t) {
    const e = {},
      s = $(t),
      n = s ? Object.keys(t) : t,
      o = $(i) ? (s ? (r) => R(i[r], i[t[r]]) : (r) => i[r]) : () => i;
    for (const r of n) e[r] = AC(o(r));
    return e;
  }
  function Ou(i) {
    return Ja(i, { top: "y", right: "x", bottom: "y", left: "x" });
  }
  function Ci(i) {
    return Ja(i, ["topLeft", "topRight", "bottomLeft", "bottomRight"]);
  }
  function ht(i) {
    const t = Ou(i);
  ...
  function Du(i, t = { scriptable: !0, indexable: !0 }) {
    const {
  ...
  function SC(i, t, e) {
    ...
    let a = s[t];
    return (
      Ue(a) && r.isScriptable(t) && (a = OC(t, a, i, e)),
      Q(a) && a.length && (a = DC(t, a, i, r.isIndexable)),
      el(t, a) && (a = cs(a, n, o && o[t], r)),
      a
    );
  }
  function OC(i, t, e, s) {
  ...
  const MC = (i, t) =>
    i === !0 ? t : typeof i == "string" ? Ke(t, i) : void 0;
  function IC(i, t, e, s, n) {
    for (const o of t) {
      const r = MC(e, o);
      if (r) {
  ...
  function il(i, t, e, s) {
    const n = t._rootScopes,
      o = Iu(t._fallback, e, s),
      r = [...i, ...n],
      a = new Set();
    a.add(s);
    let l = Lu(a, r, e, o || e, s);
    return l === null ||
      (Ft(o) && o !== e && ((l = Lu(a, r, o, l, s)), l === null))
      ? !1
      : tl(Array.from(a), [""], n, o, () => LC(t, e, s));
  }
  ...
  function PC(i, t, e, s) {
    let n;
    for (const o of t)
      if (((n = Pu(kC(o, i), e)), Ft(n))) return el(i, n) ? il(e, s, i, n) : n;
  }
  function Pu(i, t) {
    for (const e of t) {
      if (!e) continue;
  ...
  function Nu(i, t, e, s) {
    ...
    let a, l, c, h;
    for (a = 0, l = s; a < l; ++a)
      (c = a + e), (h = t[c]), (r[a] = { r: n.parse(Ke(h, o), c) });
    return r;
  }
  const NC = Number.EPSILON || 1e-14,
    hs = (i, t) => t < i.length && !i[t].skip && i[t],
    $u = (i) => (i === "x" ? "y" : "x");
  function $C(i, t, e, s) {
    const n = i.skip ? t : i,
      o = t,
    ...
    for (e = 0, s = i.length; e < s; ++e)
      (r = o),
        ...
        o &&
          ((n = i[e]),
          r &&
            ((n.cp1x = Xo(n.cp1x, t.left, t.right)),
            (n.cp1y = Xo(n.cp1y, t.top, t.bottom))),
          a &&
            ((n.cp2x = Xo(n.cp2x, t.left, t.right)),
            (n.cp2y = Xo(n.cp2y, t.top, t.bottom))));
  }
  function WC(i, t, e, s, n) {
    ...
    if (
      ...
      for (o = 0, r = i.length; o < r; ++o)
        (a = i[o]),
          (l = $C(c, a, i[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension)),
          (a.cp1x = l.previous.x),
          (a.cp1y = l.previous.y),
          (a.cp2x = l.next.x),
          (a.cp2y = l.next.y),
  ...
  const jC = ["top", "right", "bottom", "left"];
  function Ti(i, t, e) {
    const s = {};
    e = e ? "-" + e : "";
    for (let n = 0; n < 4; n++) {
    ...
    if (t === void 0 || e === void 0) {
      ...
      if (!o) (t = i.clientWidth), (e = i.clientHeight);
        ...
        (t = r.width - c.width - l.width),
          ...
          (s = Go(a.maxWidth, o, "clientWidth")),
          (n = Go(a.maxHeight, o, "clientHeight"));
      }
    }
    return { width: t, height: e, maxWidth: s || Ho, maxHeight: n || Ho };
  }
  const nl = (i) => Math.round(i * 10) / 10;
  function XC(i, t, e, s) {
    const n = qo(i),
      o = Ti(n, "margin"),
      r = Go(n.maxWidth, i, "clientWidth") || Ho,
      a = Go(n.maxHeight, i, "clientHeight") || Ho,
      l = UC(i, t, e);
    let { width: c, height: h } = l;
    if (n.boxSizing === "content-box") {
      const d = Ti(n, "border", "width"),
        u = Ti(n, "padding");
    ...
    return (
      ...
      (c = nl(Math.min(c, r, l.maxWidth))),
      (h = nl(Math.min(h, a, l.maxHeight))),
      c && !h && (h = nl(c / 2)),
      { width: c, height: h }
    );
  }
  ...
  function ju(i) {
    return i === "angle"
      ? { between: Js, compare: FE, normalize: Nt }
      : { between: Ae, compare: (t, e) => t - e, normalize: (t) => t };
  }
  ...
  function Ku(i, t, e) {
    ...
    const { property: s, start: n, end: o } = e,
      r = t.length,
      { compare: a, between: l, normalize: c } = ju(s),
      { start: h, end: d, loop: u, style: f } = eT(i, t, e),
      p = [];
    let _ = !1,
      m = null,
      y,
    ...
    for (let S = h, k = h; S <= d; ++S)
      (x = t[S % r]),
        !x.skip &&
          ...
          y !== E &&
            ((_ = l(y, n, o)),
            m === null && A() && (m = a(y, n) === 0 ? S : k),
            m !== null &&
              w() &&
              (p.push(Yu({ start: m, end: S, loop: u, count: r, style: f })),
              (m = null)),
            (k = S),
            (E = y)));
    return (
      m !== null &&
        p.push(Yu({ start: m, end: d, loop: u, count: r, style: f })),
      p
    );
  }
  function Uu(i, t) {
  ...
  function nT(i, t) {
    ...
    if (!n) return [];
    const o = !!i._loop,
      { start: r, end: a } = iT(e, n, o, s);
    if (s === !0) return Xu(i, [{ start: r, end: a, loop: o }], e, t);
    const l = a < r ? a + n : a,
  ...
  function oT(i, t, e, s) {
    ...
    function f(p, _, m, y) {
      ...
      if (p !== _) {
        ...
        for (; e[_ % l].skip; ) _ += x;
        p % l !== _ % l &&
          (c.push({ start: p % l, end: _ % l, loop: m, style: y }),
          (h = y),
          (d = _ % l));
      }
    }
  ...
  class Zu {
    constructor(t, e, s, n) {
      ...
      (this._active = !0),
        (this._fn = t.fn || lT[t.type || typeof r]),
  ...
  const cT = ["x", "y", "borderWidth", "radius", "tension"],
    hT = ["color", "borderColor", "backgroundColor"];
  B.set("animation", {
    delay: void 0,
    duration: 1e3,
    easing: "easeOutQuart",
  ...
  B.describe("animation", {
    ...
    B.set("animations", {
      colors: { type: "color", properties: hT },
      numbers: { type: "number", properties: cT },
    }),
    B.describe("animations", { _fallback: "animation" }),
    B.set("transitions", {
  ...
  class ol {
    ...
    _animateOptions(t, e) {
      ...
      return (
        s.$shared &&
          uT(t.options.$animations, s).then(
            () => {
              t.options = s;
            },
            () => {}
  ...
  function nf(i, t) {
    ...
    for (let f = 0; f < d; ++f) {
      ...
      (u = y[c] = vT(n, h, _)),
        (u[a] = m),
        (u._top = sf(u, r, !0, s.type)),
        (u._bottom = sf(u, r, !1, s.type));
    }
  }
  function rl(i, t) {
    const e = i.scales;
  ...
  const al = (i) => i === "reset" || i === "none",
    of = (i, t) => (t ? i : Object.assign({}, i)),
    ET = (i, t, e) =>
      i && !t.hidden && t._stacked && { keys: Ju(e, !0), values: null };
  class zt {
    constructor(t, e) {
      (this.chart = t),
        (this._ctx = t.ctx),
    ...
    linkScales() {
      const t = this.chart,
        ...
        o = (e.xAxisID = R(s.xAxisID, rl(t, "x"))),
        r = (e.yAxisID = R(s.yAxisID, rl(t, "y"))),
        a = (e.rAxisID = R(s.rAxisID, rl(t, "r"))),
        l = e.indexAxis,
    ...
    _dataCheck() {
      ...
      if ($(e)) this._data = gT(e);
        ...
        e && Object.isExtensible(e) && jE(e, this),
          (this._syncList = []),
          (this._data = e);
      }
    }
    ...
    buildOrUpdateElements(t) {
      ...
      (e._stacked = ef(e.vScale, e)),
        e.stack !== s.stack && ((n = !0), ln(e), (e.stack = s.stack)),
        this._resyncElements(t),
        (n || o !== e._stacked) && nf(this, e._parsed);
    }
    configure() {
    ...
    parsePrimitiveData(t, e, s, n) {
      ...
      for (u = 0, f = n; u < f; ++u)
        (p = u + s),
          (d[u] = { [a]: h || o.parse(c[p], p), [l]: r.parse(e[p], p) });
      return d;
    }
    ...
    parseObjectData(t, e, s, n) {
      ...
      for (h = 0, d = n; h < d; ++h)
        (u = h + s),
          (f = e[u]),
          (c[h] = { x: o.parse(Ke(f, a), u), y: r.parse(Ke(f, l), u) });
      return c;
    }
    getParsed(t) {
    ...
    applyStack(t, e, s) {
      const n = this.chart,
        o = this._cachedMeta,
        r = e[t.axis],
        a = { keys: Ju(n, !0), values: e._stacks[t.axis] };
      return tf(a, r, o.index, { mode: s });
    }
    updateRangeFromParsed(t, e, s, n) {
      const o = s[e.axis];
      let r = o === null ? NaN : o;
      const a = n && s._stacks[e.axis];
      n && a && ((n.values = a), (r = tf(n, o, this._cachedMeta.index))),
    ...
    getMinMax(t, e) {
      ...
      for (
        u = 0;
        u < r && !(!p() && (this.updateRangeFromParsed(c, t, f, l), o));
        ++u
      );
      if (o) {
        for (u = r - 1; u >= 0; --u)
    ...
    _update(t) {
      ...
      this.update(t || "default"),
        (e._clip = _T(
          R(this.options.clip, pT(e.xScale, e.yScale, this.getMaxOverflow()))
        ));
    }
    update(t) {}
    draw() {
    ...
    getContext(t, e, s) {
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        (o = r.$context || (r.$context = xT(this.getContext(), t, r))),
    ...
    _resolveElementOptions(t, e = "default", s) {
      const n = e === "active",
        ...
        r = t + "-" + e,
        a = o[r],
        l = this.enableOptionSharing && Ft(s);
      if (a) return of(a, l);
      const c = this.chart.config,
        ...
        p = () => this.getContext(s, n),
        _ = c.resolveNamedOptions(u, f, p, d);
      return (
        _.$shared && ((_.$shared = l), (o[r] = Object.freeze(of(_, l)))), _
      );
    }
  ...
  (zt.defaults = {}),
    (zt.prototype.datasetElementType = null),
    (zt.prototype.dataElementType = null);
  function CT(i, t) {
    if (!i._cache.$bar) {
  ...
  function TT(i) {
    ...
    const l = () => {
      r === 32767 ||
        r === -32768 ||
        (Ft(a) && (s = Math.min(s, Math.abs(r - a) || s)), (a = r));
    };
  ...
  class cn extends zt {
    ...
    parseObjectData(t, e, s, n) {
      ...
      for (u = s, f = s + n; u < f; ++u)
        (_ = e[u]),
          (p = {}),
          (p[o.axis] = o.parse(Ke(_, c), u)),
          d.push(rf(Ke(_, h), p, r, u));
      return d;
    }
    updateRangeFromParsed(t, e, s, n) {
      ...
      for (let f = e; f < e + s; f++) {
        const p = this.getParsed(f),
          ...
          x = {
            ...
            base: _.base,
            enableBorderRadius:
              !y || ll(p._custom) || r === y._top || r === y._bottom,
            x: c ? _.head : m.center,
            y: c ? m.center : _.head,
    ...
    _calculateBarValuePixels(t) {
      ...
      return { size: p, base: m, head: f, center: f + p / 2 };
    }
    _calculateBarIndexPixels(t, e) {
      const s = e.scale,
        n = this.options,
        o = n.skipNull,
        r = R(n.maxBarThickness, 1 / 0);
      let a, l;
      if (e.grouped) {
        const c = o ? this._getStackCount(t) : e.stackCount,
          h = n.barThickness === "flex" ? wT(t, e, n, c) : AT(t, e, n, c),
    ...
    updateElements(t, e, s, n) {
      ...
      for (let u = e; u < e + s; u++) {
        const f = t[u],
          ...
          _ = {},
          m = (_[h] = o ? r.getPixelForDecimal(0.5) : r.getPixelForValue(p[h])),
          y = (_[d] = o ? a.getBasePixel() : a.getPixelForValue(p[d]));
        (_.skip = isNaN(m) || isNaN(y)),
          c &&
            ((_.options =
              l || this.resolveDataElementOptions(u, f.active ? "active" : n)),
            o && (_.options.radius = 0)),
          this.updateElement(f, u, _, n);
      }
    }
    resolveDataElementOptions(t, e) {
      ...
      const o = n.radius;
      return (
        e !== "active" && (n.radius = 0), (n.radius += R(s && s._custom, o)), n
      );
    }
  }
  (hn.id = "bubble"),
  ...
  function LT(i, t, e) {
    ...
    if (t < q) {
      const a = i,
        ...
        d = Math.cos(l),
        u = Math.sin(l),
        f = (E, C, T) => (Js(E, a, l, !0) ? 1 : Math.max(C, C * e, T, T * e)),
        p = (E, C, T) => (Js(E, a, l, !0) ? -1 : Math.min(C, C * e, T, T * e)),
        _ = f(0, c, d),
        m = f(nt, h, u),
        y = p(et, c, d),
        x = p(et + nt, h, u);
  ...
  class ki extends zt {
    ...
    update(t) {
      const e = this.chart,
        ...
        l = Math.min(DE(this.options.cutout, a), 1),
        c = this._getRingWeight(this.index),
        { circumference: h, rotation: d } = this._getRotationExtents(),
        { ratioX: u, ratioY: f, offsetX: p, offsetY: _ } = LT(d, h, l),
        m = (s.width - r) / u,
        y = (s.height - r) / f,
        x = Math.max(Math.min(m, y) / 2, 0),
        E = Jd(this.options.radius, x),
        C = Math.max(E * l, 0),
        T = (E - C) / this._getVisibleDatasetWeightTotal();
      (this.offsetX = p * E),
        (this.offsetY = _ * E),
    ...
    updateElements(t, e, s, n) {
      const o = n === "reset",
        ...
        { sharedOptions: _, includeOptions: m } = this._getSharedOptions(e, n);
      ...
      for (x = e; x < e + s; ++x) {
        ...
        m &&
          (T.options =
            _ || this.resolveDataElementOptions(x, C.active ? "active" : n)),
          (y += E),
          this.updateElement(C, x, T, n);
      }
    }
    calculateTotal() {
      const t = this._cachedMeta,
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        s = this.chart,
        n = s.data.labels || [],
        o = an(e._parsed[t], s.options.locale);
  ...
  class dn extends zt {
    ...
    updateElements(t, e, s, n) {
      const o = n === "reset",
        ...
        u = r.axis,
        f = a.axis,
        { spanGaps: p, segment: _ } = this.options,
      ...
      for (let E = e; E < e + s; ++E) {
        const C = t[E],
          ...
          A = y ? C : {},
          w = N(T[f]),
          S = (A[u] = r.getPixelForValue(T[u], E)),
          k = (A[f] =
            o || w
              ? a.getBasePixel()
              : a.getPixelForValue(l ? this.applyStack(a, T, l) : T[f], E));
        (A.skip = isNaN(S) || isNaN(k) || w),
          (A.stop = E > 0 && Math.abs(T[u] - x[u]) > m),
          _ && ((A.parsed = T), (A.raw = c.data[E])),
          d &&
            (A.options =
              h || this.resolveDataElementOptions(E, C.active ? "active" : n)),
          y || this.updateElement(C, E, A, n),
          (x = T);
      }
    }
    getMaxOverflow() {
  ...
  class un extends zt {
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        s = this.chart,
        n = s.data.labels || [],
        o = an(e._parsed[t].r, s.options.locale);
      return { label: n[t] || "", value: o };
    }
    parseObjectData(t, e, s, n) {
    ...
    updateElements(t, e, s, n) {
      ...
      for (p = e; p < e + s; p++) {
        const m = t[p];
        let y = f,
          x = f + this._computeAngle(p, n, _),
          E = r.getDataVisibility(p)
    ...
    _computeAngle(t, e, s) {
      return this.chart.getDataVisibility(t)
        ? Jt(this.resolveDataElementOptions(t, e).angle || s)
        : 0;
    }
  }
  (un.id = "polarArea"),
  ...
  B.set("scale", {
    ...
    B.route("scale.ticks", "color", "", "color"),
    B.route("scale.grid", "color", "", "borderColor"),
    B.route("scale.grid", "borderColor", "", "borderColor"),
    B.route("scale.title", "color", "", "color"),
    B.describe("scale", {
      _fallback: !1,
      _scriptable: (i) =>
        !i.startsWith("before") &&
    ...
    B.describe("scales", { _fallback: "scale" }),
  ...
  function RT(i, t) {
    const e = i.options.ticks,
      s = e.maxTicksLimit || NT(i),
      n = e.major.enabled ? BT(t) : [],
      o = n.length,
      r = n[0],
      a = n[o - 1],
      l = [];
    ...
    if (o > 0) {
      ...
      for (Qo(t, l, c, N(u) ? 0 : r - u, r), h = 0, d = o - 1; h < d; h++)
        Qo(t, l, c, n[h], n[h + 1]);
  ...
  function Qo(i, t, e, s, n) {
    const o = R(s, 0),
      r = Math.min(R(n, i.length), i.length);
    let a = 0,
      l,
      c,
      h;
  ...
  const VT = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
    df = (i, t, e) => (t === "top" || t === "left" ? i[t] + e : i[t] - e);
  function uf(i, t) {
    const e = [],
      s = i.length / t,
      n = i.length;
  ...
  function jT(i, t) {
    return qe(i, { scale: t, type: "scale" });
  }
  function YT(i, t, e) {
    return qe(i, { tick: e, index: t, type: "tick" });
  }
  function KT(i, t, e) {
    let s = za(i);
  ...
  class Ze extends jt {
    ...
    getUserBounds() {
      ...
      return (
        ...
        (s = Ht(s, Number.POSITIVE_INFINITY)),
        (n = Ht(n, Number.NEGATIVE_INFINITY)),
        { min: Ht(t, s), max: Ht(e, n), minDefined: rt(t), maxDefined: rt(e) }
      );
    }
    getMinMax(t) {
      let {
      ...
      return (
        (e = o && e > s ? s : e),
        (s = n && e > s ? e : s),
        { min: Ht(e, Ht(s, e)), max: Ht(s, Ht(e, s)) }
      );
    }
    getPadding() {
      return {
    ...
    update(t, e, s) {
      ...
      this.beforeUpdate(),
        ...
        this._dataLimitsCached ||
          ...
          (this._range = wC(this, o, n)),
          (this._dataLimitsCached = !0)),
        this.beforeBuildTicks(),
        (this.ticks = this.buildTicks() || []),
        this.afterBuildTicks();
      const l = a < this.ticks.length;
      this._convertTicksToLabels(l ? uf(this.ticks, a) : this.ticks),
        this.configure(),
    ...
    calculateLabelRotation() {
      ...
      const h = this._getLabelSizes(),
        d = h.widest.width,
        u = h.highest.height,
        f = ct(this.chart.width - d, 0, this.maxWidth);
      (a = t.offset ? this.maxWidth / s : f / (s - 1)),
        d + 6 > a &&
          ...
          (l =
            ...
            _n(t.grid) -
            e.padding -
            ff(t.title, this.chart.options.font)),
          (c = Math.sqrt(d * d + u * u)),
          (r = Fa(
            Math.min(
    ...
    fit() {
      ...
      if (r) {
        ...
        if (
          (a
            ? ((t.width = this.maxWidth), (t.height = _n(o) + l))
            : ((t.height = this.maxHeight), (t.width = _n(o) + l)),
    ...
    _computeLabelSizes(t, e) {
      ...
      for (c = 0; c < e; ++c) {
        if (
          ...
          (y = Yo(s, _.data, _.gc, y, u)), (x = m);
        else if (Q(u))
          for (h = 0, d = u.length; h < d; ++h)
            (E = u[h]),
              !N(E) && !Q(E) && ((y = Yo(s, _.data, _.gc, y, E)), (x += m));
    ...
    getContext(t) {
      ...
      return (
        this.$context || (this.$context = jT(this.chart.getContext(), this))
      );
    }
    _tickSize() {
    ...
    _computeGridLineItems(t) {
      ...
      const L = R(n.ticks.maxTicksLimit, h),
        X = Math.max(1, Math.ceil(h / L));
      for (x = 0; x < h; x += X) {
        const I = o.setContext(this.getContext(x)),
          F = I.lineWidth,
          Y = I.color,
          Yt = I.borderDash || [],
          ee = I.borderDashOffset,
          ie = I.tickWidth,
          ti = I.tickColor,
          Kt = I.tickBorderDash || [],
          ye = I.tickBorderDashOffset;
        (E = WT(this, x, a)),
          E !== void 0 &&
            ((C = xi(s, E, F)),
            l ? (T = w = k = O = C) : (A = S = D = M = C),
            u.push({
              tx1: T,
              ty1: A,
              tx2: w,
    ...
    _computeLabelItems(t) {
      ...
      let y,
        ...
        L = "middle";
      if (n === "top")
        (A = this.bottom - p), (w = this._getXAxisLabelAlignment());
      else if (n === "bottom")
        (A = this.top + p), (w = this._getXAxisLabelAlignment());
      else if (n === "left") {
      ...
      for (y = 0, x = a.length; y < x; ++y) {
        ...
        const F = O / 2,
          Y = I.color,
          Yt = I.textStrokeColor,
          ee = I.textStrokeWidth;
        let ie = w;
        r
          ? ((T = S),
            w === "inner" &&
            ...
            n === "top"
              ? c === "near" || _ !== 0
                ? (M = -O * D + D / 2)
                : c === "center"
                ? (M = -X.highest.height / 2 - F * D + D)
                : (M = -X.highest.height + D / 2)
              : c === "near" || _ !== 0
              ? (M = D / 2)
              : c === "center"
              ? (M = X.highest.height / 2 - F * D)
              : (M = X.highest.height - O * D),
            d && (M *= -1))
          : ((A = S), (M = ((1 - O) * D) / 2));
        let ti;
        if (I.showLabelBackdrop) {
          const Kt = ht(I.backdropPadding),
            ye = X.heights[y],
            xe = X.widths[y];
          let Ut = A + M - Kt.top,
            Me = T - Kt.left;
    ...
    drawBorder() {
      ...
      let l, c, h, d;
      this.isHorizontal()
        ? ((l = xi(t, this.left, o) - o / 2),
          (c = xi(t, this.right, r) + r / 2),
          (h = d = a))
        : ((h = xi(t, this.top, o) - o / 2),
          (d = xi(t, this.bottom, r) + r / 2),
          (l = c = a)),
        e.save(),
  ...
  class Jo {
    ...
    register(t) {
      ...
      return (
        o in n ||
          ((n[o] = t),
          XT(t, r, s),
          this.override && B.override(t.id, t.overrides)),
        r
      );
    }
    get(t) {
    ...
    unregister(t) {
      const e = this.items,
        ...
        n = this.scope;
      s in e && delete e[s],
        n && s in B[n] && (delete B[n][s], this.override && delete yi[s]);
    }
  }
  function XT(i, t, e) {
    ...
    B.set(t, s),
      i.defaultRoutes && GT(t, i.defaultRoutes),
      i.descriptors && B.describe(t, i.descriptors);
  }
  function GT(i, t) {
    Object.keys(t).forEach((e) => {
      const s = e.split("."),
  ...
  class ZT {
    constructor() {
      (this.controllers = new Jo(zt, "datasets", !0)),
        (this.elements = new Jo(jt, "elements")),
        (this.plugins = new Jo(Object, "plugins")),
        (this.scales = new Jo(Ze, "scales")),
  ...
  class gn extends zt {
    ...
    addElements() {
      ...
      !this.datasetElementType &&
        t &&
        (this.datasetElementType = te.getElement("line")),
        super.addElements();
    }
    updateElements(t, e, s, n) {
      const o = n === "reset",
        ...
        y = as(_) ? _ : Number.POSITIVE_INFINITY,
      ...
      for (let C = e; C < e + s; ++C) {
        const T = t[C],
          ...
          w = x ? T : {},
          S = N(A[p]),
          k = (w[f] = r.getPixelForValue(A[f], C)),
          D = (w[p] =
            o || S
              ? a.getBasePixel()
              : a.getPixelForValue(l ? this.applyStack(a, A, l) : A[p], C));
        (w.skip = isNaN(k) || isNaN(D) || S),
          (w.stop = C > 0 && Math.abs(A[f] - E[f]) > y),
          m && ((w.parsed = A), (w.raw = c.data[C])),
          u &&
            (w.options =
              d || this.resolveDataElementOptions(C, T.active ? "active" : n)),
          x || this.updateElement(T, C, w, n),
          (E = A);
      }
  ...
  function tA(i, t, e, s) {
    ...
    function o(r, a, l) {
      const { startAngle: c, endAngle: h } = r.getProps(
        ...
        { angle: d } = au(r, { x: t.x, y: t.y });
      Js(d, c, h) && n.push({ element: r, datasetIndex: a, index: l });
    }
    return mn(i, e, t, o), n;
  }
    ...
    modes: {
      index(i, t, e, s) {
        const n = Ai(t, i),
          ...
          a = e.intersect ? hl(i, n, o, s, r) : dl(i, n, o, !1, s, r),
          l = [];
        return a.length
  ...
  const bf = ["left", "top", "right", "bottom"];
  function bn(i, t) {
  ...
  function rA(i, t, e, s) {
    ...
    const a = Math.max(0, t.outerWidth - yf(r, i, "left", "right")),
      l = Math.max(0, t.outerHeight - yf(r, i, "top", "bottom")),
      c = a !== i.w,
      h = l !== i.h;
    return (
      (i.w = a),
  ...
  function yn(i, t, e, s) {
    ...
    for (o = 0, r = i.length, c = 0; o < r; ++o) {
      (a = i[o]),
        (l = a.box),
        l.update(a.width || t.w, a.height || t.h, lA(a.horizontal, t));
    ...
    for (const a of i) {
      ...
      if (a.horizontal) {
        ...
        Ft(c.start) && (r = c.start),
          l.fullSize
            ? tr(l, n.left, r, e.outerWidth - n.right - n.left, u)
            : tr(l, t.left + c.placed, r, d, u),
          (c.start = r),
          (c.placed += d),
          (r = l.bottom);
      } else {
        ...
        Ft(c.start) && (o = c.start),
          l.fullSize
            ? tr(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
            : tr(l, o, t.top + c.placed, u, d),
          (c.start = o),
          (c.placed += d),
          (o = l.right);
      }
  ...
  var dt = {
    ...
    update(i, t, e, s) {
      ...
      const h =
          l.reduce(
            (_, m) =>
              m.box.options && m.box.options.display === !1 ? _ : _ + 1,
            0
          ) || 1,
        d = Object.freeze({
          outerWidth: t,
      ...
      yn(a.fullSize, f, d, p),
        yn(l, f, d, p),
        yn(c, f, d, p) && yn(l, f, d, p),
        aA(f),
        Ef(a.leftAndTop, f, d, p),
        (f.x += f.w),
        (f.y += f.h),
        Ef(a.rightAndBottom, f, d, p),
        (i.chartArea = {
          left: f.left,
          top: f.top,
          right: f.left + f.w,
  ...
  function pA(i, t, e) {
    const s = i.canvas,
      n = new MutationObserver((o) => {
        let r = !1;
        for (const a of o)
          (r = r || ir(a.addedNodes, s)), (r = r && !ir(a.removedNodes, s));
        r && e();
      });
  ...
  function _A(i, t, e) {
    const s = i.canvas,
      n = new MutationObserver((o) => {
        let r = !1;
        for (const a of o)
          (r = r || ir(a.removedNodes, s)), (r = r && !ir(a.addedNodes, s));
        r && e();
      });
    return n.observe(document, { childList: !0, subtree: !0 }), n;
  }
  ...
  class Sf extends ul {
    ...
    addEventListener(t, e, s) {
      ...
      const n = t.$proxies || (t.$proxies = {}),
        r = { attach: pA, detach: _A, resize: bA }[e] || vA;
      n[e] = r(t, e, s);
    }
    removeEventListener(t, e) {
      const s = t.$proxies || (t.$proxies = {}),
        n = s[e];
      if (!n) return;
      (({ attach: fl, detach: fl, resize: fl }[e] || uA)(t, e, n),
        (s[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  class yA {
    ...
    _createDescriptors(t, e) {
      const s = t && t.config,
        n = R(s.options && s.options.plugins, {}),
        o = xA(s);
  ...
  function CA(i, { plugins: t, localIds: e }, s, n) {
    ...
    for (const a of t) {
      ...
      c !== null &&
        o.push({
          plugin: a,
          options: TA(i.config, { plugin: a, local: e[l] }, c, r),
        });
    }
    return o;
  }
  ...
  function _l(i, t) {
    return i === "x" || i === "y"
      ? i
      : t.axis || kA(t.position) || i.charAt(0).toLowerCase();
  }
  function SA(i, t) {
    const e = yi[i.type] || { scales: {} },
      s = t.scales || {},
      n = pl(i.type, t),
    ...
    return (
      Object.keys(s).forEach((a) => {
        ...
        const c = _l(a, l),
          ...
          d = e.scales || {};
        (o[c] = o[c] || a),
          (r[a] = qs(Object.create(null), [{ axis: c }, l, d[c], d[h]]));
      }),
      i.data.datasets.forEach((a) => {
        const l = a.type || i.type,
          c = a.indexAxis || pl(l, t),
          d = (yi[l] || {}).scales || {};
        Object.keys(d).forEach((u) => {
          const f = AA(u, c),
            p = a[f + "AxisID"] || o[f] || f;
          (r[p] = r[p] || Object.create(null)),
            qs(r[p], [{ axis: f }, s[p], d[u]]);
        });
      }),
      Object.keys(r).forEach((a) => {
        const l = r[a];
        qs(l, [B.scales[l.type], B.scale]);
      }),
      r
    );
  }
  ...
  class DA {
    ...
    getOptionScopes(t, e, s) {
      ...
      const l = new Set();
      e.forEach((h) => {
        t && (l.add(t), h.forEach((d) => En(l, t, d))),
          h.forEach((d) => En(l, n, d)),
          h.forEach((d) => En(l, yi[o] || {}, d)),
          h.forEach((d) => En(l, B, d)),
          h.forEach((d) => En(l, qa, d));
      });
    ...
    chartOptionScopes() {
      ...
      return [t, yi[e] || {}, B.datasets[e] || {}, { type: e }, B, qa];
    }
  ...
  const MA = (i) =>
    $(i) && Object.getOwnPropertyNames(i).reduce((t, e) => t || Ue(i[e]), !1);
  function IA(i, t) {
  ...
  var LA = "3.9.1";
  const PA = ["top", "bottom", "left", "right", "chartArea"];
  function Rf(i, t) {
  ...
  class gl {
    constructor(t, e) {
      ...
      (this.platform = new (s.platform || Of(n))()),
      ...
      if (
        ...
        (this.scales = {}),
        (this._plugins = new yA()),
        (this.$proxies = {}),
        (this._hiddenIndices = {}),
        (this.attached = !1),
        (this._animationsDisabled = void 0),
        (this.$context = void 0),
        (this._doResize = YE((d) => this.update(d), r.resizeDelay || 0)),
        (this._dataChanges = []),
        (nr[this.id] = this),
        !a || !l)
      ) {
      ...
      be.listen(this, "complete", $f),
        be.listen(this, "progress", RA),
        this._initialize(),
    ...
    _initialize() {
      return (
        ...
        this.options.responsive
          ? this.resize()
          : Hu(this, this.options.devicePixelRatio),
        this.bindEvents(),
      ...
      e &&
        ...
        U(o, (r) => {
          const a = r.options,
            ...
            c = _l(l, a),
            h = R(a.type, r.dtype);
          (a.position === void 0 || Rf(a.position, c) !== Rf(r.dposition)) &&
    ...
    buildOrUpdateControllers() {
      ...
      for (
        ...
        if (
          ...
          (r.type = a),
          (r.indexAxis = o.indexAxis || pl(a, this.options)),
          (r.order = o.order || 0),
          (r.index = s),
          (r.label = "" + o.label),
          ...
          const l = te.getController(a),
            { datasetElementType: c, dataElementType: h } = B.datasets[a];
    ...
    _checkEventBindings() {
      const t = this.options,
        ...
        s = new Set(t.events);
      (!iu(e, s) || !!this._responsiveListeners !== t.responsive) &&
    ...
    _updateDatasets(t) {
      if (
        ...
        for (let e = 0, s = this.data.datasets.length; e < s; ++e)
          this._updateDataset(e, Ue(t) ? t({ datasetIndex: e }) : t);
    ...
    render() {
      this.notifyPlugins("beforeRender", { cancelable: !0 }) !== !1 &&
        (be.has(this)
          ? this.attached && !be.running(this) && be.start(this)
          : (this.draw(), $f({ chart: this })));
    }
    draw() {
      let t;
    ...
    _stop() {
      let t, e;
      for (
        this.stop(), be.remove(this), t = 0, e = this.data.datasets.length;
        t < e;
        ++t
      )
  ...
  const Ff = () => U(gl.instances, (i) => i._plugins.invalidate()),
    Qe = !0;
  Object.defineProperties(gl, {
    defaults: { enumerable: Qe, value: B },
    instances: { enumerable: Qe, value: nr },
    overrides: { enumerable: Qe, value: yi },
    registry: { enumerable: Qe, value: te },
    version: { enumerable: Qe, value: LA },
    getChart: { enumerable: Qe, value: Hf },
    register: {
      enumerable: Qe,
      value: (...i) => {
        te.add(...i), Ff();
  ...
  function BA(i) {
    return Ja(i, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
  }
  function HA(i, t, e, s) {
    const n = BA(i.options.borderRadius),
      o = (e - t) / 2,
      r = Math.min(o, (s * t) / 2),
      a = (l) => {
  ...
  function ml(i, t, e, s, n, o) {
    ...
    const _ = Math.max(0.001, p * d - e / et) / d,
      m = (p - _) / 2,
      y = l + m + f,
      x = n - m - f,
      {
  ...
  function VA(i, t, e) {
    ...
    let h;
    for (
      e && Vf(i, t, o + q), i.beginPath(), i.arc(s, n, c, o + q, o, !0), h = 0;
      h < a;
      ++h
    )
      i.stroke();
  ...
  class fs extends jt {
    ...
    inRange(t, e, s) {
      const n = this.getProps(["x", "y"], s),
        { angle: o, distance: r } = au(n, { x: t, y: e }),
        {
          startAngle: a,
          endAngle: l,
          innerRadius: c,
  ...
  (fs.id = "arc"),
    ...
    (fs.defaultRoutes = { backgroundColor: "backgroundColor" });
  function Wf(i, t, e = t) {
    (i.lineCap = R(e.borderCapStyle, t.borderCapStyle)),
      i.setLineDash(R(e.borderDash, t.borderDash)),
      (i.lineDashOffset = R(e.borderDashOffset, t.borderDashOffset)),
      (i.lineJoin = R(e.borderJoinStyle, t.borderJoinStyle)),
      (i.lineWidth = R(e.borderWidth, t.borderWidth)),
      (i.strokeStyle = R(e.borderColor, t.borderColor));
  }
  function zA(i, t, e) {
    i.lineTo(e.x, e.y);
  }
  ...
  function YA(i, t, e, s) {
    const { points: n, options: o } = t,
      { count: r, start: a, loop: l, ilen: c } = zf(n, e, s),
      h = jA(o);
    ...
    for (f = 0; f <= c; ++f)
      (p = n[(a + (u ? c - f : f)) % r]),
        !p.skip &&
          (d ? (i.moveTo(p.x, p.y), (d = !1)) : h(i, _, p, u, o.stepped),
          (_ = p));
    return l && ((p = n[(a + (u ? c : 0)) % r]), h(i, _, p, u, o.stepped)), !!l;
  }
  function KA(i, t, e, s) {
    const n = t.points,
      { count: o, start: r, ilen: a } = zf(n, e, s),
    ...
    for (l && ((f = n[x(0)]), i.moveTo(f.x, f.y)), u = 0; u <= a; ++u) {
      ...
      const C = f.x,
        ...
        A = C | 0;
      A === p
        ? (T < _ ? (_ = T) : T > m && (m = T), (h = (d * h + C) / ++d))
        : (E(), i.lineTo(C, T), (p = A), (d = 0), (_ = m = T)),
        (y = T);
    }
    E();
  }
  ...
  class Se extends jt {
    ...
    get segments() {
      return (
        this._segments || (this._segments = nT(this, this.options.segment))
      );
    }
    first() {
    ...
    interpolate(t, e) {
      const s = this.options,
        n = t[e],
        o = this.points,
        r = Uu(this, { property: e, start: n, end: n });
      if (!r.length) return;
      const a = [],
        l = UA(s);
      let c, h;
      for (c = 0, h = r.length; c < h; ++c) {
        ...
        const _ = Math.abs((n - f[e]) / (p[e] - f[e])),
          m = l(f, p, _, s.stepped);
        (m[e] = t[e]), a.push(m);
      }
    ...
    draw(t, e, s, n) {
      ...
      (this.points || []).length &&
        o.borderWidth &&
        (t.save(), ZA(t, this, s, n), t.restore()),
  ...
  function sw(i, t, e, s, n) {
    ...
    for (r[l++] = i[h], d = 0; d < o - 2; d++) {
      ...
      const E = Math.floor((d + 1) * a) + 1 + t,
        C = Math.min(Math.floor((d + 2) * a) + 1, e) + t,
        T = C - E;
      ...
      const A = Math.floor(d * a) + 1 + t,
        ...
        { x: S, y: k } = i[h];
      for (f = p = -1, x = A; x < w; x++)
        (p = 0.5 * Math.abs((S - m) * (i[x].y - k) - (S - i[x].x) * (y - k))),
          p > f && ((f = p), (u = i[x]), (_ = x));
      (r[l++] = u), (h = _);
    }
    return (r[l++] = i[c]), r;
      ...
      if (T === h)
        ...
        if (!N(d) && !N(u)) {
          const w = Math.min(d, u),
            S = Math.max(d, u);
          w !== f && w !== A && m.push({ ...i[w], x: n }),
            S !== f && S !== A && m.push({ ...i[S], x: n });
        }
        r > 0 && A !== f && m.push(i[A]),
          m.push(a),
          (h = T),
  ...
  function ow(i, t) {
    ...
    return (
      l && (s = ct(we(t, o.axis, r).lo, 0, e - 1)),
      c ? (n = ct(we(t, o.axis, a).hi + 1, s, e) - s) : (n = e - s),
      { start: s, count: n }
    );
  }
  var Gf = {
  ...
  function rw(i, t, e) {
    ...
    for (const a of s) {
      ...
      const d = Uu(t, h);
      for (const u of d) {
        const f = xl(e, o[u.start], o[u.end], u.loop),
          p = Ku(a, n, f);
        for (const _ of p)
          r.push({
            source: _,
            target: u,
            start: { [e]: qf(h, f, "start", Math.max) },
            end: { [e]: qf(h, f, "end", Math.min) },
          });
      }
    }
    return r;
  ...
  function Zf(i, t) {
    let e = [],
      s = !1;
    return (
      Q(i) ? ((s = !0), (e = i)) : (e = aw(i, t)),
      e.length
        ? new Se({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s })
        : null
    );
  }
  function Qf(i) {
  ...
  function pw(i) {
    const { scale: t, index: e, line: s } = i,
      ...
      r = s.points,
      a = _w(t, e);
    a.push(Zf({ x: null, y: t.bottom }, s));
    for (let l = 0; l < o.length; l++) {
      const c = o[l];
      for (let h = c.start; h <= c.end; h++) gw(n, r[h], a);
    }
    return new Se({ points: n, options: {} });
  }
  function _w(i, t) {
    const e = [],
  ...
  function gw(i, t, e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const o = e[n],
        { first: r, last: a, point: l } = mw(o, t, "x");
      if (!(!l || (r && a))) {
        if (r) s.unshift(l);
  ...
  function Cw(i, t) {
    ...
    i.save(),
      l === "x" &&
        o !== n &&
        (tp(i, s, r.top),
        ep(i, { line: e, target: s, color: n, scale: a, property: l }),
        i.restore(),
        i.save(),
        tp(i, s, r.bottom)),
      ep(i, { line: e, target: s, color: o, scale: a, property: l }),
      i.restore();
  }
  function tp(i, t, e) {
    ...
    afterDatasetsUpdate(i, t, e) {
      ...
      for (r = 0; r < s; ++r)
        (o = i.getDatasetMeta(r)),
          ...
          n.push(l);
      for (r = 0; r < s; ++r)
        (l = n[r]), !(!l || l.fill === !1) && (l.fill = lw(n, r, e.propagate));
    },
    beforeDraw(i, t, e) {
  ...
  class op extends jt {
    ...
    fit() {
      ...
      const s = t.labels,
        ...
        { boxWidth: a, itemHeight: l } = np(s, o);
      let c, h;
      (e.font = n.string),
        this.isHorizontal()
    ...
    _fitRows(t, e, s, n) {
      ...
      return (
        this.legendItems.forEach((p, _) => {
          ...
          (_ === 0 || c[c.length - 1] + m + 2 * a > r) &&
            ((d += h), (c[c.length - (_ > 0 ? 0 : 1)] = 0), (f += h), u++),
            (l[_] = { left: 0, top: f, row: u, width: m, height: n }),
            (c[c.length - 1] += m + a);
        }),
        d
      );
      ...
      return (
        this.legendItems.forEach((m, y) => {
          ...
          y > 0 &&
            ...
            _++,
            (u = f = 0)),
            (l[y] = { left: p, top: f, col: _, width: x, height: n }),
            (u = Math.max(u, x)),
            (f += n + a);
        }),
        (d += u),
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        let a = 0,
          l = pt(s, this.left + n, this.right - this.lineWidths[a]);
        for (const c of e)
          a !== c.row &&
            ((a = c.row),
            (l = pt(s, this.left + n, this.right - this.lineWidths[a]))),
        ...
        let a = 0,
          l = pt(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
        for (const c of e)
          c.col !== a &&
            ((a = c.col),
            (l = pt(
    ...
    _draw() {
      ...
      this.drawTitle(),
        ...
        (n.lineWidth = 0.5),
        (n.font = c.string);
      const { boxWidth: _, boxHeight: m, itemHeight: y } = np(r, u),
        x = function (w, S, k) {
          if (isNaN(_) || _ <= 0 || isNaN(m) || m < 0) return;
          n.save();
          const D = R(k.lineWidth, 1);
          if (
            ((n.fillStyle = R(k.fillStyle, a)),
            (n.lineCap = R(k.lineCap, "butt")),
            (n.lineDashOffset = R(k.lineDashOffset, 0)),
            (n.lineJoin = R(k.lineJoin, "miter")),
            (n.lineWidth = D),
            (n.strokeStyle = R(k.strokeStyle, a)),
            n.setLineDash(R(k.lineDash, [])),
            r.usePointStyle)
          ) {
            const O = {
            ...
            const O = S + Math.max((u - m) / 2, 0),
              M = l.leftForLtr(w, _),
              L = Ci(k.borderRadius);
            n.beginPath(),
              Object.values(L).some((X) => X !== 0)
                ? rn(n, { x: M, y: O, w: _, h: m, radius: L })
                : n.rect(M, O, _, m),
              n.fill(),
              D !== 0 && n.stroke();
          }
        ...
        l.setWidth(this.width),
          C
            ? S > 0 &&
              ...
              ((L = p.y += A),
              p.line++,
              (M = p.x = pt(o, this.left + d, this.right - s[p.line])))
            : S > 0 &&
              L + A > this.bottom &&
              ((M = p.x = M + e[p.line].width + d),
              p.line++,
              (L = p.y =
                pt(o, this.top + T + d, this.bottom - e[p.line].height)));
        const X = l.x(M);
        x(X, L, w),
          (M = KE(D, M + _ + f, C ? M + O : this.right, t.rtl)),
          E(l.x(M), L, w),
          C ? (p.x += O + d) : (p.y += A);
      }),
    ...
    _getLegendItemAt(t, e) {
      ...
      if (Ae(t, this.left, this.right) && Ae(e, this.top, this.bottom)) {
        for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
          if (
            ((n = o[s]),
            Ae(t, n.left, n.left + n.width) && Ae(e, n.top, n.top + n.height))
          )
  ...
  var rp = {
    ...
    _element: op,
    start(i, t, e) {
      const s = (i.legend = new op({ ctx: i.ctx, options: e, chart: i }));
  ...
  class Tl extends jt {
    ...
    _drawArgs(t) {
      ...
      return (
        this.isHorizontal()
          ? ((h = pt(a, s, o)), (d = e + t), (c = o - s))
          : (r.position === "left"
              ? ((h = s + t), (d = pt(a, n, e)), (l = et * -0.5))
              : ((h = o - t), (d = pt(a, e, n)), (l = et * 0.5)),
            (c = n - e)),
  ...
  function kw(i, t) {
    const e = new Tl({ ctx: i.ctx, options: t, chart: i });
  ...
  var lp = {
    id: "subtitle",
    start(i, t, e) {
      const s = new Tl({ ctx: i.ctx, options: e, chart: i });
...
`)
  ...
  function cp(i, t) {
    ...
    let _ = p.height,
      m = 0,
      y = s.reduce(
        (C, T) => C + T.before.length + T.lines.length + T.after.length,
        0
      );
    if (
    ...
    u &&
      (_ += t.footerMarginTop + u * h.lineHeight + (u - 1) * t.footerSpacing);
    let x = 0;
    const E = function (C) {
  ...
  function hp(i, t, e) {
    ...
    return { xAlign: e.xAlign || t.xAlign || Mw(i, t, e, s), yAlign: s };
  }
  function Iw(i, t) {
    let { x: e, width: s } = i;
  ...
  function dp(i, t, e, s) {
    const { caretSize: n, caretPadding: o, cornerRadius: r } = i,
      { xAlign: a, yAlign: l } = e,
      c = n + o,
      { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = Ci(r);
    let p = Iw(t, a);
    const _ = Lw(t, l, c);
    return (
      l === "center"
        ...
        : a === "left"
        ? (p -= Math.max(h, u) + n)
        : a === "right" && (p += Math.max(d, f) + n),
      { x: ct(p, 0, s.width - t.width), y: ct(_, 0, s.height - t.height) }
    );
  }
  function rr(i, t, e) {
  ...
  function Pw(i, t, e) {
    return qe(i, { tooltip: t, tooltipItems: e, type: "tooltip" });
  }
  function fp(i, t) {
    const e =
  ...
  class Al extends jt {
    ...
    _resolveAnimations() {
      ...
      const e = this.chart,
        ...
        o = new ol(this.chart, n);
      return n._cacheable && (this._cachedAnimations = Object.freeze(o)), o;
    }
    getContext() {
      return (
        this.$context ||
        (this.$context = Pw(this.chart.getContext(), this, this._tooltipItems))
      );
    }
    getTitle(t, e) {
      const { callbacks: s } = e,
    ...
    getBeforeBody(t, e) {
      return up(e.callbacks.beforeBody.apply(this, [t]));
    }
    getBody(t, e) {
      const { callbacks: s } = e,
        n = [];
      return (
        U(t, (o) => {
          const r = { before: [], lines: [], after: [] },
            a = fp(s, o);
          ve(r.before, Oe(a.beforeLabel.call(this, o))),
            ve(r.lines, a.label.call(this, o)),
            ve(r.after, Oe(a.afterLabel.call(this, o))),
            n.push(r);
        }),
        n
      );
    ...
    getAfterBody(t, e) {
      return up(e.callbacks.afterBody.apply(this, [t]));
    }
    getFooter(t, e) {
      const { callbacks: s } = e,
    ...
    update(t, e) {
      ...
      if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
        ...
        const l = (this._size = cp(this, s)),
          c = Object.assign({}, a, l),
          h = hp(this.chart, s, c),
          d = dp(s, c, h, this.chart);
    ...
    getCaretPosition(t, e, s) {
      const { xAlign: n, yAlign: o } = this,
        ...
        { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = Ci(a),
        { x: u, y: f } = t,
        { width: p, height: _ } = e;
      let m, y, x, E, C, T;
      return (
        o === "center"
          ? ((C = f + _ / 2),
            n === "left"
              ? ((m = u), (y = m - r), (E = C + r), (T = C - r))
              : ((m = u + p), (y = m + r), (E = C - r), (T = C + r)),
            (x = m))
          : (n === "left"
              ? (y = u + Math.max(l, h) + r)
              : n === "right"
              ? (y = u + p - Math.max(c, d) - r)
              : (y = this.caretX),
            o === "top"
              ? ((E = f), (C = E - r), (m = y - r), (x = y + r))
              : ((E = f + _), (C = E + r), (m = y + r), (x = y - r)),
            (T = E)),
        { x1: m, x2: y, x3: x, y1: E, y2: C, y3: T }
      );
    }
    drawTitle(t, e, s) {
      const n = this.title,
    ...
    _drawColorBox(t, e, s, n, o) {
      ...
      if (o.usePointStyle) {
        ...
        Object.values(x).some((E) => E !== 0)
          ? (t.beginPath(),
            (t.fillStyle = o.multiKeyBackground),
            rn(t, { x: m, y: _, w: c, h: l, radius: x }),
            t.fill(),
            t.stroke(),
            (t.fillStyle = r.backgroundColor),
            t.beginPath(),
            rn(t, { x: y, y: _ + 1, w: c - 2, h: l - 2, radius: x }),
            t.fill())
          : ((t.fillStyle = o.multiKeyBackground),
            t.fillRect(m, _, c, l),
            t.strokeRect(m, _, c, l),
            (t.fillStyle = r.backgroundColor),
            t.fillRect(y, _ + 1, c - 2, l - 2));
      }
    ...
    drawBody(t, e, s) {
      ...
      for (
        ...
        for (
          y = n[C],
            x = this.labelTextColors[C],
            e.fillStyle = x,
            U(y.before, _),
            E = y.lines,
            a &&
              E.length &&
              (this._drawColorBox(e, t, C, p, s),
  ...
  var pp = {
      ...
      positioners: Cn,
      afterInit(i, t, e) {
        e && (i.tooltip = new Al({ chart: i, options: e }));
      },
      beforeUpdate(i, t, e) {
  ...
  class Tn extends Ze {
    ...
    parse(t, e) {
      ...
      return (
        (e =
          isFinite(e) && s[e] === t ? e : Nw(s, t, R(e, t), this._addedLabels)),
        $w(e, s.length - 1)
      );
    }
    determineDataLimits() {
  ...
  (Tn.id = "category"),
    (Tn.defaults = { ticks: { callback: Tn.prototype.getLabelForValue } });
  function Bw(i, t) {
    const e = [],
      {
        bounds: n,
    ...
    let T = nu((m - _) / p / f) * f,
      ...
      S,
      k;
    if (T < 1e-14 && !y && !x) return [{ value: _ }, { value: m }];
    (k = Math.ceil(m / T) - Math.floor(_ / T)),
      k > p && (T = nu((k * T) / p / f) * f),
      N(l) || ((A = Math.pow(10, l)), (T = Math.ceil(T * A) / A)),
      n === "ticks"
        ? ((w = Math.floor(_ / T) * T), (S = Math.ceil(m / T) * T))
        : ((w = _), (S = m)),
      y && x && o && HE((a - r) / o, T / 1e3)
        ? ((k = Math.round(Math.min((a - r) / T, h))),
          (T = (a - r) / k),
          (w = r),
          (S = a))
        : E
        ? ((w = y ? r : w), (S = x ? a : S), (k = c - 1), (T = (S - w) / k))
        : ((k = (S - w) / T),
          Qs(k, Math.round(k), T / 1e3)
            ? (k = Math.round(k))
            : (k = Math.ceil(k)));
    const D = Math.max(ru(T), ru(w));
    (A = Math.pow(10, N(l) ? D : l)),
      (w = Math.round(w * A) / A),
      (S = Math.round(S * A) / A);
    let O = 0;
    for (
      ...
      (u && w !== r
        ? (e.push({ value: r }),
          w < r && O++,
          Qs(Math.round((w + O * T) * A) / A, r, gp(r, C, i)) && O++)
        : w < r && O++);
      O < k;
      ++O
    )
      e.push({ value: Math.round((w + O * T) * A) / A });
    return (
      x && u && S !== a
        ? e.length && Qs(e[e.length - 1].value, a, gp(a, C, i))
  ...
  class ar extends Ze {
    ...
    buildTicks() {
      ...
      const n = {
        ...
        r = Bw(n, o);
      return (
        t.bounds === "ticks" && ou(r, this, "value"),
        t.reverse
  ...
  (lr.id = "linear"),
    (lr.defaults = { ticks: { callback: pn.formatters.numeric } });
  function mp(i) {
  ...
  class cr extends Ze {
    ...
    parse(t, e) {
      const s = ar.prototype.parse.apply(this, [t, e]);
      if (s === 0) {
        this._zero = !0;
        return;
      }
    ...
    buildTicks() {
      const t = this.options,
        ...
        s = Hw(e, this);
      return (
        t.bounds === "ticks" && ou(s, this, "value"),
        t.reverse
    ...
    getLabelForValue(t) {
      return t === void 0
        ? "0"
        : an(t, this.chart.options.locale, this.options.ticks.format);
    }
    configure() {
      const t = this.min;
      super.configure(),
  ...
  (cr.id = "logarithmic"),
    (cr.defaults = {
      ticks: { callback: pn.formatters.logarithmic, major: { enabled: !0 } },
    });
  function wl(i) {
    const t = i.ticks;
  ...
  function Fw(i, t, e) {
    return (
      (e = Q(e) ? e : [e]),
      { w: mC(i, t.string, e), h: e.length * t.lineHeight }
    );
  }
  ...
  function Vw(i) {
    ...
    for (let l = 0; l < o; l++) {
      ...
      const h = i.getPointPosition(l, i.drawingArea + n[l], a),
        d = lt(c.font),
        u = Fw(i.ctx, d, i._pointLabels[l]);
      s[l] = u;
      const f = Nt(i.getIndexAngle(l) + a),
        p = Math.round(Fa(f)),
        _ = bp(p, h.x, u.w, 0, 180),
        m = bp(p, h.y, u.h, 90, 270);
      Ww(e, t, f, _, m);
    }
    i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b),
      (i._pointLabelItems = zw(i, s, n));
  }
  ...
  function Uw(i, t) {
    ...
    for (let n = t - 1; n >= 0; n--) {
      const o = s.setContext(i.getPointLabelContext(n)),
        ...
        { backdropColor: p } = o;
      if (!N(p)) {
        const _ = Ci(o.borderRadius),
          m = ht(o.backdropPadding);
        e.fillStyle = p;
        const y = h - m.left,
          x = d - m.top,
          E = u - h + m.width,
          C = f - d + m.height;
        Object.values(_).some((T) => T !== 0)
          ? (e.beginPath(),
            rn(e, { x: y, y: x, w: E, h: C, radius: _ }),
            e.fill())
          : e.fillRect(y, x, E, C);
      }
  ...
  function Gw(i, t, e) {
    return qe(i, { label: e, index: t, type: "pointLabel" });
  }
  class gs extends ar {
    constructor(t) {
      super(t),
    ...
    setDimensions() {
      const t = (this._padding = ht(wl(this.options) / 2)),
    ...
    generateTickLabels(t) {
      ar.prototype.generateTickLabels.call(this, t),
    ...
    drawGrid() {
      ...
      let r, a, l;
      if (
        (e.pointLabels.display && Uw(this, o),
        n.display &&
    ...
    drawLabels() {
      ...
      t.save(),
        ...
        this.ticks.forEach((a, l) => {
          ...
          Ei(t, a.label, 0, -o, h, { color: c.color });
        }),
        t.restore();
    }
    drawTitle() {}
  ...
  (gs.id = "radialLinear"),
    ...
    (gs.descriptors = { angleLines: { _fallback: "grid" } });
  const hr = {
  ...
  function Qw(i) {
    for (let t = kt.indexOf(i) + 1, e = kt.length; t < e; ++t)
      if (hr[kt[t]].common) return kt[t];
  }
  function Ep(i, t, e) {
    if (!e) i[t] = !0;
    else if (e.length) {
      const { lo: s, hi: n } = Wa(e, t),
        o = e[s] >= t ? e[s] : e[n];
      i[o] = !0;
    }
  }
  ...
  class ms extends Ze {
    ...
    init(t, e) {
      const s = t.time || (t.time = {}),
        n = (this._adapter = new _f._date(t.adapters.date));
      n.init(e),
        qs(s.displayFormats, n.formats()),
        (this._parseOpts = {
          parser: s.parser,
          round: s.round,
    ...
    buildTicks() {
      ...
      return (
        (this._unit =
          e.unit ||
          (s.autoSkip
            ? xp(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
            : Zw(this, a.length, e.minUnit, this.min, this.max))),
        (this._majorUnit =
          !s.major.enabled || this._unit === "year" ? void 0 : Qw(this._unit)),
        this.initOffsets(n),
        t.reverse && a.reverse(),
        Cp(this, a, this._majorUnit)
      );
    }
    afterAutoSkip() {
    ...
    _generate() {
      const t = this._adapter,
        ...
        n = this.options,
        o = n.time,
        r = o.unit || xp(o.minUnit, e, s, this._getLabelCapacity(e)),
        a = R(o.stepSize, 1),
      ...
      return (
        (u === s || n.bounds === "ticks" || f === 1) && Ep(h, u, p),
        Object.keys(h)
          .sort((_, m) => _ - m)
          .map((_) => +_)
      );
    ...
    _getLabelCapacity(t) {
      const e = this.options.time,
        ...
        o = this._tickFormatFunction(t, 0, Cp(this, [t], this._majorUnit), n),
  ...
  function dr(i, t, e) {
    let s = 0,
      ...
      l;
    e
      ? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = we(i, "pos", t)),
        ({ pos: o, time: a } = i[s]),
        ({ pos: r, time: l } = i[n]))
      : (t >= i[s].time &&
          t <= i[n].time &&
          ({ lo: s, hi: n } = we(i, "time", t)),
        ({ time: o, pos: a } = i[s]),
        ({ time: r, pos: l } = i[n]));
    const c = r - o;
  ...
  class ur extends ms {
    ...
    initOffsets() {
      ...
      (this._minPos = dr(e, this.min)),
        (this._tableRange = dr(e, this.max) - this._minPos),
        super.initOffsets(t);
    }
    buildLookupTable(t) {
...
`)
  ...
  function fr(i, t, e) {
    var s = ik;
    return (
      i < e.left ? (s |= wp) : i > e.right && (s |= kp),
      t < e.top ? (s |= Op) : t > e.bottom && (s |= Sp),
      s
    );
  }
  function sk(i, t) {
  ...
  function pr(i, t) {
    var e = t.anchor,
      ...
      o;
    return (
      t.clamp && (s = sk(s, t.area)),
      e === "start"
        ? ((n = s.x0), (o = s.y0))
        : e === "end"
        ? ((n = s.x1), (o = s.y1))
        : ((n = (s.x0 + s.x1) / 2), (o = (s.y0 + s.y1) / 2)),
      ek(n, o, i.vx, i.vy, t.align)
    );
  }
  var _r = {
      arc: function (i, t) {
      ...
      bar: function (i, t) {
        ...
        return (
          ...
          pr({ x0: s, y0: n + r, x1: s + o, y1: n, vx: e.x, vy: e.y }, t)
        );
      },
  ...
  ge(Dp.prototype, {
    ...
    update: function (i) {
      ...
      c &&
        ((r = i.dataset.data[n]),
        (a = R(G(o.formatter, [r, i]), r)),
        (l = N(a) ? [] : An.toTextLines(a)),
        l.length && ((e = t._modelize(c, l, o, i)), (s = nk(e)))),
        (t._model = e),
        (t._rects = s);
    },
    geometry: function () {
    ...
    draw: function (i, t) {
      ...
      this.visible() &&
        ...
        n.clip &&
          ...
          s.clip()),
        (s.globalAlpha = An.bound(0, n.opacity, 1)),
        s.translate(De(t.x), De(t.y)),
        s.rotate(n.rotation),
        lk(s, o.frame, n),
        dk(s, n.lines, o.text, n),
        s.restore());
    },
  });
  var uk = Number.MIN_SAFE_INTEGER || -9007199254740991,
    fk = Number.MAX_SAFE_INTEGER || 9007199254740991;
  function wn(i, t, e) {
    var s = Math.cos(e),
      n = Math.sin(e),
      o = t.x,
  ...
  ge(Ip.prototype, {
    ...
    intersects: function (i) {
      var t = this._points(),
        e = i._points(),
        s = [gr(t[0], t[1]), gr(t[0], t[3])],
        n,
        o,
        r;
      for (
        this._rotation !== i._rotation &&
          s.push(gr(e[0], e[1]), gr(e[0], e[3])),
          n = 0;
        n < s.length;
        ++n
      )
        if (
          ((o = Mp(t, s[n])), (r = Mp(e, s[n])), o.max < r.min || r.max < o.min)
        )
          return !1;
      return !0;
    },
    _points: function () {
      ...
      return [
        wn({ x: t.x, y: t.y }, s, e),
        wn({ x: t.x + t.w, y: t.y }, s, e),
        wn({ x: t.x + t.w, y: t.y + t.h }, s, e),
        wn({ x: t.x, y: t.y + t.h }, s, e),
      ];
    },
  });
  function Lp(i, t, e) {
  ...
  var Ek = {
    ...
    afterEvent: function (i) {
      ...
      (t._dirty || n.length) && (kn.update(t._labels), i.render()),
        delete t._dirty;
    },
  };
  const Ck = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Ek },
      Symbol.toStringTag,
      { value: "Module" }
    )
  );
